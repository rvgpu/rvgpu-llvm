//===--- RVGPU.h - Declare RVGPU target feature support -------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file declares RVGPU TargetInfo objects.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_CLANG_LIB_BASIC_TARGETS_RVGPU_H
#define LLVM_CLANG_LIB_BASIC_TARGETS_RVGPU_H
...
class LLVM_LIBRARY_VISIBILITY RVGPUTargetInfo final : public TargetInfo {

  static const char *const GCCRegNames[];

  static const LangASMap RVGPUDefIsGenMap;
  static const LangASMap RVGPUDefIsPrivMap;

  llvm::RVGPU::GPUKind GPUKind;
  ...
  bool hasFP64() const {
    return getTriple().getArch() == llvm::Triple::rvgpu ||
           !!(GPUFeatures & llvm::RVGPU::FEATURE_FP64);
  }

  /// Has fast fma f32
  bool hasFastFMAF() const {
    return !!(GPUFeatures & llvm::RVGPU::FEATURE_FAST_FMA_F32);
  }
  ...
  bool hasFMAF() const {
    return getTriple().getArch() == llvm::Triple::rvgpu ||
           !!(GPUFeatures & llvm::RVGPU::FEATURE_FMA);
  }

  bool hasFullRateDenormalsF32() const {
    return !!(GPUFeatures & llvm::RVGPU::FEATURE_FAST_DENORMAL_F32);
  }

  bool hasLDEXPF() const {
    return getTriple().getArch() == llvm::Triple::rvgpu ||
           !!(GPUFeatures & llvm::RVGPU::FEATURE_LDEXP);
  }

  static bool isRVGPU(const llvm::Triple &TT) {
    return TT.getArch() == llvm::Triple::rvgpu;
  }
...
public:
  ...
  uint64_t getPointerWidthV(LangAS AS) const override {
    ...
    if (TargetAS == llvm::RVGPUAS::PRIVATE_ADDRESS ||
        TargetAS == llvm::RVGPUAS::LOCAL_ADDRESS)
      return 32;
  ...
  uint64_t getMaxPointerWidth() const override {
    return getTriple().getArch() == llvm::Triple::rvgpu ? 64 : 32;
  }

  bool hasBFloat16Type() const override { return isRVGPU(getTriple()); }
  ...
  bool isValidCPUName(StringRef Name) const override {
    return llvm::RVGPU::parseArchRVGPU(Name) != llvm::RVGPU::GK_NONE;
  }

  void fillValidCPUList(SmallVectorImpl<StringRef> &Values) const override;

  bool setCPU(const std::string &Name) override {
    GPUKind = llvm::RVGPU::parseArchRVGPU(Name);
    GPUFeatures = llvm::RVGPU::getArchAttrRVGPU(GPUKind);
    return GPUKind != llvm::RVGPU::GK_NONE;
  }
  ...
  void setSupportedOpenCLOpts() override {
    ...
    Opts["cl_rv_media_ops"] = true;
    Opts["cl_rv_media_ops2"] = true;
  ...
  std::optional<LangAS> getConstantAddressSpace() const override {
    return getLangASFromTargetAS(llvm::RVGPUAS::CONSTANT_ADDRESS);
  }

  const llvm::omp::GV &getGridValue() const override {
    switch (WavefrontSize) {
    case 32:
      return llvm::omp::getRVGPUGridValues<32>();
    case 64:
      return llvm::omp::getRVGPUGridValues<64>();
    default:
  ...
  unsigned getVtblPtrAddressSpace() const override {
    return static_cast<unsigned>(llvm::RVGPUAS::CONSTANT_ADDRESS);
  }
  ...
  getDWARFAddressSpace(unsigned AddressSpace) const override {
    ...
    if (AddressSpace == llvm::RVGPUAS::PRIVATE_ADDRESS) {
      return DWARF_Private;
    } else if (AddressSpace == llvm::RVGPUAS::LOCAL_ADDRESS) {
      return DWARF_Local;
    } else {
      return std::nullopt;
    }
  ...
  // In rvgpu target the null pointer in global, constant, and generic
  ...
  bool handleTargetFeatures(std::vector<std::string> &Features,
    ...
    auto TargetIDFeatures =
        getAllPossibleTargetIDFeatures(getTriple(), getArchNameRVGPU(GPUKind));
  ...
  std::optional<std::string> getTargetID() const override {
    ...
    if (GPUKind == llvm::RVGPU::GK_NONE)
      return std::string("");
    return getCanonicalTargetID(getArchNameRVGPU(GPUKind),
                                OffloadArchFeatures);
  }
...
#endif // LLVM_CLANG_LIB_BASIC_TARGETS_RVGPU_H
