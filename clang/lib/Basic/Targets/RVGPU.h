...
static const int RVGPUDWARFAddrSpaceMap[] = {
...
class LLVM_LIBRARY_VISIBILITY RVGPUTargetInfo : public TargetInfo {
...
public:
  ...
  getDWARFAddressSpace(unsigned AddressSpace) const override {
    if (AddressSpace >= std::size(RVGPUDWARFAddrSpaceMap) ||
        RVGPUDWARFAddrSpaceMap[AddressSpace] < 0)
      return std::nullopt;
    return RVGPUDWARFAddrSpaceMap[AddressSpace];
  }
