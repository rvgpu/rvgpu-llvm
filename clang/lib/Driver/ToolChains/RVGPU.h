//===--- RVGPU.h - RVGPU ToolChain Implementations ----------*- C++ -*-===//
//
...
#ifndef LLVM_CLANG_LIB_DRIVER_TOOLCHAINS_RVGPU_H
#define LLVM_CLANG_LIB_DRIVER_TOOLCHAINS_RVGPU_H
...
public:
  Linker(const ToolChain &TC) : Tool("rvgpu::Linker", "ld.lld", TC) {}
...
class LLVM_LIBRARY_VISIBILITY RVGPUToolChain : public Generic_ELF {
protected:
...
public:
  ...
  /// for the subtarget.
  static bool getDefaultDenormsAreZeroForTarget(llvm::RVGPU::GPUKind GPUKind);
  ...
  /// Uses rvgpu-arch tool to get arch of the system GPU. Will return error
...
#endif // LLVM_CLANG_LIB_DRIVER_TOOLCHAINS_RVGPU_H
