//===- lib/Target/RVGPU/RVGPUCallLowering.h - Call lowering -*- C++ -*---===//
//
...
#ifndef LLVM_LIB_TARGET_RVGPU_RVGPUCALLLOWERING_H
#define LLVM_LIB_TARGET_RVGPU_RVGPUCALLLOWERING_H

#include "llvm/CodeGen/GlobalISel/CallLowering.h"

namespace llvm {

class RVGPUTargetLowering;
class RVSubtarget;
class MachineInstrBuilder;
class RVMachineFunctionInfo;

class RVGPUCallLowering final : public CallLowering {
...
public:
  RVGPUCallLowering(const RVGPUTargetLowering &TLI);
  ...
  void handleImplicitCallArguments(
      ...
      const RVSubtarget &ST, const RVMachineFunctionInfo &MFI,
