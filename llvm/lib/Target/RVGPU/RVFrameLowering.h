...
#ifndef LLVM_LIB_TARGET_RVGPU_SIFRAMELOWERING_H
#define LLVM_LIB_TARGET_RVGPU_SIFRAMELOWERING_H
...
class RVFrameLowering final : public RVGPUFrameLowering {
public:
  RVFrameLowering(StackDirection D, Align StackAl, int LAO,
                  Align TransAl = Align(1))
      : RVGPUFrameLowering(D, StackAl, LAO, TransAl) {}
  ~RVFrameLowering() override = default;
...
#endif // LLVM_LIB_TARGET_RVGPU_SIFRAMELOWERING_H
