//=== RVGPUPrintfRuntimeBinding.cpp - OpenCL printf implementation -------===//
//
...
namespace {
class RVGPUPrintfRuntimeBinding final : public ModulePass {

public:
  static char ID;

  explicit RVGPUPrintfRuntimeBinding();

private:
  bool runOnModule(Module &M) override;
};

class RVGPUPrintfRuntimeBindingImpl {
public:
  RVGPUPrintfRuntimeBindingImpl() {}
  bool run(Module &M);
...
char RVGPUPrintfRuntimeBinding::ID = 0;

INITIALIZE_PASS_BEGIN(RVGPUPrintfRuntimeBinding,
                      "rvgpu-printf-runtime-binding", "RVGPU Printf lowering",
                      false, false)
INITIALIZE_PASS_DEPENDENCY(TargetLibraryInfoWrapperPass)
INITIALIZE_PASS_DEPENDENCY(DominatorTreeWrapperPass)
INITIALIZE_PASS_END(RVGPUPrintfRuntimeBinding, "rvgpu-printf-runtime-binding",
                    "RVGPU Printf lowering", false, false)

char &llvm::RVGPUPrintfRuntimeBindingID = RVGPUPrintfRuntimeBinding::ID;

namespace llvm {
ModulePass *createRVGPUPrintfRuntimeBinding() {
  return new RVGPUPrintfRuntimeBinding();
}
} // namespace llvm

RVGPUPrintfRuntimeBinding::RVGPUPrintfRuntimeBinding() : ModulePass(ID) {
  initializeRVGPUPrintfRuntimeBindingPass(*PassRegistry::getPassRegistry());
}

void RVGPUPrintfRuntimeBindingImpl::getConversionSpecifiers(
...
bool RVGPUPrintfRuntimeBindingImpl::lowerPrintfForGpu(Module &M) {
  ...
  for (auto *CI : Printfs) {
    ...
    Type *idPointer = PointerType::get(I32Ty, RVGPUAS::GLOBAL_ADDRESS);
    Value *id_gep_cast =
...
bool RVGPUPrintfRuntimeBindingImpl::run(Module &M) {
...
bool RVGPUPrintfRuntimeBinding::runOnModule(Module &M) {
  return RVGPUPrintfRuntimeBindingImpl().run(M);
}

PreservedAnalyses
RVGPUPrintfRuntimeBindingPass::run(Module &M, ModuleAnalysisManager &AM) {
  bool Changed = RVGPUPrintfRuntimeBindingImpl().run(M);
