//===-- RVRegisterInfo.h - SI Register Info Interface ----------*- C++ -*--===//
//
...
//
/// \file
/// Interface definition for RVRegisterInfo
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_RVGPU_SIREGISTERINFO_H
#define LLVM_LIB_TARGET_RVGPU_SIREGISTERINFO_H
...
public:
  ...
  /// (e.g. getSubRegFromChannel(0) -> RVGPU::sub0)
  ...
  // Functions with the rvgpu_cs_chain or rvgpu_cs_chain_preserve calling
  ...
  const TargetRegisterClass *getBoolRC() const {
    return isWave32 ? &RVGPU::SReg_32RegClass
