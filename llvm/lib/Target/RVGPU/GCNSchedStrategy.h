...
#ifndef LLVM_LIB_TARGET_RVGPU_GCNSCHEDSTRATEGY_H
#define LLVM_LIB_TARGET_RVGPU_GCNSCHEDSTRATEGY_H
...
private:
  ...
  bool sinkTriviallyRematInsts(const RVSubtarget &ST,
...
#endif // LLVM_LIB_TARGET_RVGPU_GCNSCHEDSTRATEGY_H
