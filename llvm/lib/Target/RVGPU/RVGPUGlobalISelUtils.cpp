...
RVGPU::getBaseWithConstantOffset(MachineRegisterInfo &MRI, Register Reg,
...
bool RVGPU::hasAtomicFaddRtnForTy(const RVSubtarget &Subtarget,
                                   const LLT &Ty) {
  if (Ty == LLT::scalar(32))
