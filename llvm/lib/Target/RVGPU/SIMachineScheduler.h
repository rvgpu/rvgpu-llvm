...
#ifndef LLVM_LIB_TARGET_RVGPU_SIMACHINESCHEDULER_H
#define LLVM_LIB_TARGET_RVGPU_SIMACHINESCHEDULER_H
...
class SIScheduleDAGMI final : public ScheduleDAGMILive {
  const RVInstrInfo *SITII;
  const RVRegisterInfo *SITRI;
...
#endif // LLVM_LIB_TARGET_RVGPU_SIMACHINESCHEDULER_H
