...
static unsigned getOpcodeWidth(const MachineInstr &MI, const RVInstrInfo &TII) {
  const unsigned Opc = MI.getOpcode();

  if (TII.isMUBUF(Opc)) {
    // FIXME: Handle d16 correctly
    return RVGPU::getMUBUFElements(Opc);
  }
  if (TII.isImage(MI)) {
    uint64_t DMaskImm =
        TII.getNamedOperand(MI, RVGPU::OpName::dmask)->getImm();
    return llvm::popcount(DMaskImm);
  }
  if (TII.isMTBUF(Opc)) {
    return RVGPU::getMTBUFElements(Opc);
  }

  switch (Opc) {
  case RVGPU::S_BUFFER_LOAD_DWORD_IMM:
  case RVGPU::S_BUFFER_LOAD_DWORD_SGPR_IMM:
  case RVGPU::S_LOAD_DWORD_IMM:
  case RVGPU::GLOBAL_LOAD_DWORD:
  case RVGPU::GLOBAL_LOAD_DWORD_SADDR:
  case RVGPU::GLOBAL_STORE_DWORD:
  case RVGPU::GLOBAL_STORE_DWORD_SADDR:
  case RVGPU::FLAT_LOAD_DWORD:
  case RVGPU::FLAT_STORE_DWORD:
    return 1;
  case RVGPU::S_BUFFER_LOAD_DWORDX2_IMM:
  case RVGPU::S_BUFFER_LOAD_DWORDX2_SGPR_IMM:
  case RVGPU::S_LOAD_DWORDX2_IMM:
  case RVGPU::GLOBAL_LOAD_DWORDX2:
  case RVGPU::GLOBAL_LOAD_DWORDX2_SADDR:
  case RVGPU::GLOBAL_STORE_DWORDX2:
  case RVGPU::GLOBAL_STORE_DWORDX2_SADDR:
  case RVGPU::FLAT_LOAD_DWORDX2:
  case RVGPU::FLAT_STORE_DWORDX2:
    return 2;
  case RVGPU::S_BUFFER_LOAD_DWORDX3_IMM:
  case RVGPU::S_BUFFER_LOAD_DWORDX3_SGPR_IMM:
  case RVGPU::S_LOAD_DWORDX3_IMM:
  case RVGPU::GLOBAL_LOAD_DWORDX3:
  case RVGPU::GLOBAL_LOAD_DWORDX3_SADDR:
  case RVGPU::GLOBAL_STORE_DWORDX3:
  case RVGPU::GLOBAL_STORE_DWORDX3_SADDR:
  case RVGPU::FLAT_LOAD_DWORDX3:
  case RVGPU::FLAT_STORE_DWORDX3:
    return 3;
  case RVGPU::S_BUFFER_LOAD_DWORDX4_IMM:
  case RVGPU::S_BUFFER_LOAD_DWORDX4_SGPR_IMM:
  case RVGPU::S_LOAD_DWORDX4_IMM:
  case RVGPU::GLOBAL_LOAD_DWORDX4:
  case RVGPU::GLOBAL_LOAD_DWORDX4_SADDR:
  case RVGPU::GLOBAL_STORE_DWORDX4:
  case RVGPU::GLOBAL_STORE_DWORDX4_SADDR:
  case RVGPU::FLAT_LOAD_DWORDX4:
  case RVGPU::FLAT_STORE_DWORDX4:
    return 4;
  case RVGPU::S_BUFFER_LOAD_DWORDX8_IMM:
  case RVGPU::S_BUFFER_LOAD_DWORDX8_SGPR_IMM:
  case RVGPU::S_LOAD_DWORDX8_IMM:
    return 8;
  case RVGPU::DS_READ_B32:      [[fallthrough]];
  case RVGPU::DS_READ_B32_gfx9: [[fallthrough]];
  case RVGPU::DS_WRITE_B32:     [[fallthrough]];
  case RVGPU::DS_WRITE_B32_gfx9:
    return 1;
  case RVGPU::DS_READ_B64:      [[fallthrough]];
  case RVGPU::DS_READ_B64_gfx9: [[fallthrough]];
  case RVGPU::DS_WRITE_B64:     [[fallthrough]];
  case RVGPU::DS_WRITE_B64_gfx9:
    return 2;
  default:
    return 0;
  }
...
static InstClassEnum getInstClass(unsigned Opc, const RVInstrInfo &TII) {
  switch (Opc) {
  default:
    if (TII.isMUBUF(Opc)) {
      switch (RVGPU::getMUBUFBaseOpcode(Opc)) {
      default:
        return UNKNOWN;
      case RVGPU::BUFFER_LOAD_DWORD_OFFEN:
      case RVGPU::BUFFER_LOAD_DWORD_OFFEN_exact:
      case RVGPU::BUFFER_LOAD_DWORD_OFFSET:
      case RVGPU::BUFFER_LOAD_DWORD_OFFSET_exact:
      case RVGPU::BUFFER_LOAD_DWORD_VBUFFER_OFFEN:
      case RVGPU::BUFFER_LOAD_DWORD_VBUFFER_OFFEN_exact:
      case RVGPU::BUFFER_LOAD_DWORD_VBUFFER_OFFSET:
      case RVGPU::BUFFER_LOAD_DWORD_VBUFFER_OFFSET_exact:
        return BUFFER_LOAD;
      case RVGPU::BUFFER_STORE_DWORD_OFFEN:
      case RVGPU::BUFFER_STORE_DWORD_OFFEN_exact:
      case RVGPU::BUFFER_STORE_DWORD_OFFSET:
      case RVGPU::BUFFER_STORE_DWORD_OFFSET_exact:
      case RVGPU::BUFFER_STORE_DWORD_VBUFFER_OFFEN:
      case RVGPU::BUFFER_STORE_DWORD_VBUFFER_OFFEN_exact:
      case RVGPU::BUFFER_STORE_DWORD_VBUFFER_OFFSET:
      case RVGPU::BUFFER_STORE_DWORD_VBUFFER_OFFSET_exact:
        return BUFFER_STORE;
      }
    }
    if (TII.isImage(Opc)) {
      ...
      if (!RVGPU::hasNamedOperand(Opc, RVGPU::OpName::vaddr) &&
          !RVGPU::hasNamedOperand(Opc, RVGPU::OpName::vaddr0))
        return UNKNOWN;
      // Ignore BVH instructions
      if (RVGPU::getMIMGBaseOpcode(Opc)->BVH)
        return UNKNOWN;
    ...
    if (TII.isMTBUF(Opc)) {
      switch (RVGPU::getMTBUFBaseOpcode(Opc)) {
      default:
        return UNKNOWN;
      case RVGPU::TBUFFER_LOAD_FORMAT_X_BOTHEN:
      case RVGPU::TBUFFER_LOAD_FORMAT_X_BOTHEN_exact:
      case RVGPU::TBUFFER_LOAD_FORMAT_X_IDXEN:
      case RVGPU::TBUFFER_LOAD_FORMAT_X_IDXEN_exact:
      case RVGPU::TBUFFER_LOAD_FORMAT_X_OFFEN:
      case RVGPU::TBUFFER_LOAD_FORMAT_X_OFFEN_exact:
      case RVGPU::TBUFFER_LOAD_FORMAT_X_OFFSET:
      case RVGPU::TBUFFER_LOAD_FORMAT_X_OFFSET_exact:
      case RVGPU::TBUFFER_LOAD_FORMAT_X_VBUFFER_BOTHEN:
      case RVGPU::TBUFFER_LOAD_FORMAT_X_VBUFFER_BOTHEN_exact:
      case RVGPU::TBUFFER_LOAD_FORMAT_X_VBUFFER_IDXEN:
      case RVGPU::TBUFFER_LOAD_FORMAT_X_VBUFFER_IDXEN_exact:
      case RVGPU::TBUFFER_LOAD_FORMAT_X_VBUFFER_OFFEN:
      case RVGPU::TBUFFER_LOAD_FORMAT_X_VBUFFER_OFFEN_exact:
      case RVGPU::TBUFFER_LOAD_FORMAT_X_VBUFFER_OFFSET:
      case RVGPU::TBUFFER_LOAD_FORMAT_X_VBUFFER_OFFSET_exact:
        return TBUFFER_LOAD;
      case RVGPU::TBUFFER_STORE_FORMAT_X_OFFEN:
      case RVGPU::TBUFFER_STORE_FORMAT_X_OFFEN_exact:
      case RVGPU::TBUFFER_STORE_FORMAT_X_OFFSET:
      case RVGPU::TBUFFER_STORE_FORMAT_X_OFFSET_exact:
      case RVGPU::TBUFFER_STORE_FORMAT_X_VBUFFER_OFFEN:
      case RVGPU::TBUFFER_STORE_FORMAT_X_VBUFFER_OFFEN_exact:
      case RVGPU::TBUFFER_STORE_FORMAT_X_VBUFFER_OFFSET:
      case RVGPU::TBUFFER_STORE_FORMAT_X_VBUFFER_OFFSET_exact:
  ...
  case RVGPU::S_LOAD_DWORDX8_IMM:
    return S_LOAD_IMM;
  case RVGPU::DS_READ_B32:
  case RVGPU::DS_READ_B32_gfx9:
  case RVGPU::DS_READ_B64:
  case RVGPU::DS_READ_B64_gfx9:
    return DS_READ;
  case RVGPU::DS_WRITE_B32:
  case RVGPU::DS_WRITE_B32_gfx9:
  case RVGPU::DS_WRITE_B64:
  case RVGPU::DS_WRITE_B64_gfx9:
    return DS_WRITE;
  case RVGPU::GLOBAL_LOAD_DWORD:
  case RVGPU::GLOBAL_LOAD_DWORDX2:
...
static unsigned getInstSubclass(unsigned Opc, const RVInstrInfo &TII) {
  switch (Opc) {
  default:
    if (TII.isMUBUF(Opc))
      return RVGPU::getMUBUFBaseOpcode(Opc);
    if (TII.isImage(Opc)) {
    ...
    if (TII.isMTBUF(Opc))
      return RVGPU::getMTBUFBaseOpcode(Opc);
    return -1;
  case RVGPU::DS_READ_B32:
  case RVGPU::DS_READ_B32_gfx9:
  case RVGPU::DS_READ_B64:
  ...
  case RVGPU::S_BUFFER_LOAD_DWORDX4_IMM:
  case RVGPU::S_BUFFER_LOAD_DWORDX8_IMM:
    return RVGPU::S_BUFFER_LOAD_DWORD_IMM;
  case RVGPU::S_BUFFER_LOAD_DWORD_SGPR_IMM:
  case RVGPU::S_BUFFER_LOAD_DWORDX2_SGPR_IMM:
  case RVGPU::S_BUFFER_LOAD_DWORDX3_SGPR_IMM:
  case RVGPU::S_BUFFER_LOAD_DWORDX4_SGPR_IMM:
  case RVGPU::S_BUFFER_LOAD_DWORDX8_SGPR_IMM:
    return RVGPU::S_BUFFER_LOAD_DWORD_SGPR_IMM;
  case RVGPU::S_LOAD_DWORD_IMM:
  case RVGPU::S_LOAD_DWORDX2_IMM:
  case RVGPU::S_LOAD_DWORDX3_IMM:
  case RVGPU::S_LOAD_DWORDX4_IMM:
  case RVGPU::S_LOAD_DWORDX8_IMM:
    return RVGPU::S_LOAD_DWORD_IMM;
  case RVGPU::GLOBAL_LOAD_DWORD:
  case RVGPU::GLOBAL_LOAD_DWORDX2:
  case RVGPU::GLOBAL_LOAD_DWORDX3:
  case RVGPU::GLOBAL_LOAD_DWORDX4:
  ...
  case RVGPU::FLAT_LOAD_DWORDX3:
  case RVGPU::FLAT_LOAD_DWORDX4:
    return RVGPU::FLAT_LOAD_DWORD;
  case RVGPU::GLOBAL_LOAD_DWORD_SADDR:
  case RVGPU::GLOBAL_LOAD_DWORDX2_SADDR:
  case RVGPU::GLOBAL_LOAD_DWORDX3_SADDR:
  case RVGPU::GLOBAL_LOAD_DWORDX4_SADDR:
    return RVGPU::GLOBAL_LOAD_DWORD_SADDR;
  case RVGPU::GLOBAL_STORE_DWORD:
  case RVGPU::GLOBAL_STORE_DWORDX2:
  case RVGPU::GLOBAL_STORE_DWORDX3:
  case RVGPU::GLOBAL_STORE_DWORDX4:
  ...
  case RVGPU::FLAT_STORE_DWORDX3:
  case RVGPU::FLAT_STORE_DWORDX4:
    return RVGPU::FLAT_STORE_DWORD;
  case RVGPU::GLOBAL_STORE_DWORD_SADDR:
  case RVGPU::GLOBAL_STORE_DWORDX2_SADDR:
  case RVGPU::GLOBAL_STORE_DWORDX3_SADDR:
  case RVGPU::GLOBAL_STORE_DWORDX4_SADDR:
    return RVGPU::GLOBAL_STORE_DWORD_SADDR;
  }
}
...
SILoadStoreOptimizer::getCommonInstClass(const CombineInfo &CI,
  ...
  if ((CI.InstClass == FLAT_LOAD || CI.InstClass == FLAT_STORE) &&
      RVInstrInfo::isFLATGlobal(*CI.I) && RVInstrInfo::isFLATGlobal(*Paired.I))
    return (CI.InstClass == FLAT_STORE) ? GLOBAL_STORE : GLOBAL_LOAD;

  return CI.InstClass;
}

static AddressRegs getRegs(unsigned Opc, const RVInstrInfo &TII) {
  AddressRegs Result;

  if (TII.isMUBUF(Opc)) {
    if (RVGPU::getMUBUFHasVAddr(Opc))
      Result.VAddr = true;
    if (RVGPU::getMUBUFHasSrsrc(Opc))
      Result.SRsrc = true;
    if (RVGPU::getMUBUFHasSoffset(Opc))
      Result.SOffset = true;
  ...
  if (TII.isImage(Opc)) {
    ...
    if (VAddr0Idx >= 0) {
      int RsrcName =
          TII.isMIMG(Opc) ? RVGPU::OpName::srsrc : RVGPU::OpName::rsrc;
      int RsrcIdx = RVGPU::getNamedOperandIdx(Opc, RsrcName);
    ...
    Result.SRsrc = true;
    const RVGPU::MIMGInfo *Info = RVGPU::getMIMGInfo(Opc);
    if (Info && RVGPU::getMIMGBaseOpcodeInfo(Info->BaseOpcode)->Sampler)
      Result.SSamp = true;

    return Result;
  }
  if (TII.isMTBUF(Opc)) {
    if (RVGPU::getMTBUFHasVAddr(Opc))
      Result.VAddr = true;
    if (RVGPU::getMTBUFHasSrsrc(Opc))
      Result.SRsrc = true;
    if (RVGPU::getMTBUFHasSoffset(Opc))
      Result.SOffset = true;
...
void SILoadStoreOptimizer::CombineInfo::setMI(MachineBasicBlock::iterator MI,
  ...
  case DS_READ:
   EltSize =
          (Opc == RVGPU::DS_READ_B64 || Opc == RVGPU::DS_READ_B64_gfx9) ? 8
                                                                          : 4;
   break;
  case DS_WRITE:
    EltSize =
          (Opc == RVGPU::DS_WRITE_B64 || Opc == RVGPU::DS_WRITE_B64_gfx9) ? 8
                                                                            : 4;
    break;
  case S_BUFFER_LOAD_IMM:
  case S_BUFFER_LOAD_SGPR_IMM:
  case S_LOAD_IMM:
    EltSize = RVGPU::convertSMRDOffsetUnits(*LSO.STM, 4);
    break;
  default:
    EltSize = 4;
    break;
  ...
  if (InstClass == MIMG) {
    DMask = LSO.TII->getNamedOperand(*I, RVGPU::OpName::dmask)->getImm();
    // Offset is not considered for MIMG instructions.
    Offset = 0;
  } else {
    int OffsetIdx = RVGPU::getNamedOperandIdx(Opc, RVGPU::OpName::offset);
    Offset = I->getOperand(OffsetIdx).getImm();
  }

  if (InstClass == TBUFFER_LOAD || InstClass == TBUFFER_STORE)
    Format = LSO.TII->getNamedOperand(*I, RVGPU::OpName::format)->getImm();
  ...
  if ((InstClass == DS_READ) || (InstClass == DS_WRITE)) {
    ...
    CPol = LSO.TII->getNamedOperand(*I, RVGPU::OpName::cpol)->getImm();
  }
  ...
  for (unsigned J = 0; J < Regs.NumVAddrs; J++)
    AddrIdx[NumAddresses++] =
        RVGPU::getNamedOperandIdx(Opc, RVGPU::OpName::vaddr0) + J;
  if (Regs.Addr)
    AddrIdx[NumAddresses++] =
        RVGPU::getNamedOperandIdx(Opc, RVGPU::OpName::addr);
  if (Regs.SBase)
    AddrIdx[NumAddresses++] =
        RVGPU::getNamedOperandIdx(Opc, RVGPU::OpName::sbase);
  if (Regs.SRsrc)
    AddrIdx[NumAddresses++] = RVGPU::getNamedOperandIdx(
        Opc, isVIMAGEorVSAMPLE ? RVGPU::OpName::rsrc : RVGPU::OpName::srsrc);
  if (Regs.SOffset)
    AddrIdx[NumAddresses++] =
        RVGPU::getNamedOperandIdx(Opc, RVGPU::OpName::soffset);
  if (Regs.SAddr)
    AddrIdx[NumAddresses++] =
        RVGPU::getNamedOperandIdx(Opc, RVGPU::OpName::saddr);
  if (Regs.VAddr)
    AddrIdx[NumAddresses++] =
        RVGPU::getNamedOperandIdx(Opc, RVGPU::OpName::vaddr);
  if (Regs.SSamp)
    AddrIdx[NumAddresses++] = RVGPU::getNamedOperandIdx(
        Opc, isVIMAGEorVSAMPLE ? RVGPU::OpName::samp : RVGPU::OpName::ssamp);
...
SILoadStoreOptimizer::combineKnownAdjacentMMOs(const CombineInfo &CI,
  ...
  if (MMOb->getAddrSpace() == RVGPUAS::FLAT_ADDRESS)
    PtrInfo.AddrSpace = RVGPUAS::FLAT_ADDRESS;
...
bool SILoadStoreOptimizer::dmasksCanBeCombined(const CombineInfo &CI,
  ...
  const auto *TFEOp = TII.getNamedOperand(*CI.I, RVGPU::OpName::tfe);
  const auto *LWEOp = TII.getNamedOperand(*CI.I, RVGPU::OpName::lwe);

  if ((TFEOp && TFEOp->getImm()) || (LWEOp && LWEOp->getImm()))
    return false;

  // Check other optional immediate operands for equality.
  unsigned OperandsToMatch[] = {RVGPU::OpName::cpol, RVGPU::OpName::d16,
                                RVGPU::OpName::unorm, RVGPU::OpName::da,
                                RVGPU::OpName::r128, RVGPU::OpName::a16};

  for (auto op : OperandsToMatch) {
    int Idx = RVGPU::getNamedOperandIdx(CI.I->getOpcode(), op);
    if (RVGPU::getNamedOperandIdx(Paired.I->getOpcode(), op) != Idx)
      return false;
    if (Idx != -1 &&
...
static unsigned getBufferFormatWithCompCount(unsigned OldFormat,
  ...
  const llvm::RVGPU::GcnBufferFormatInfo *OldFormatInfo =
      llvm::RVGPU::getGcnBufferFormatInfo(OldFormat, STI);
  if (!OldFormatInfo)
    return 0;

  const llvm::RVGPU::GcnBufferFormatInfo *NewFormatInfo =
      llvm::RVGPU::getGcnBufferFormatInfo(OldFormatInfo->BitsPerComp,
                                           ComponentCount,
...
bool SILoadStoreOptimizer::offsetsCanBeCombined(CombineInfo &CI,
  ...
  if (CI.InstClass == TBUFFER_LOAD || CI.InstClass == TBUFFER_STORE) {
    ...
    const llvm::RVGPU::GcnBufferFormatInfo *Info0 =
        llvm::RVGPU::getGcnBufferFormatInfo(CI.Format, STI);
    if (!Info0)
      return false;
    const llvm::RVGPU::GcnBufferFormatInfo *Info1 =
        llvm::RVGPU::getGcnBufferFormatInfo(Paired.Format, STI);
    if (!Info1)
      return false;
...
SILoadStoreOptimizer::getDataRegClass(const MachineInstr &MI) const {
  if (const auto *Dst = TII->getNamedOperand(MI, RVGPU::OpName::vdst)) {
    return TRI->getRegClassForReg(*MRI, Dst->getReg());
  }
  if (const auto *Src = TII->getNamedOperand(MI, RVGPU::OpName::vdata)) {
    return TRI->getRegClassForReg(*MRI, Src->getReg());
  }
  if (const auto *Src = TII->getNamedOperand(MI, RVGPU::OpName::data0)) {
    return TRI->getRegClassForReg(*MRI, Src->getReg());
  }
  if (const auto *Dst = TII->getNamedOperand(MI, RVGPU::OpName::sdst)) {
    return TRI->getRegClassForReg(*MRI, Dst->getReg());
  }
  if (const auto *Src = TII->getNamedOperand(MI, RVGPU::OpName::sdata)) {
    return TRI->getRegClassForReg(*MRI, Src->getReg());
  }
  return nullptr;
}
...
unsigned SILoadStoreOptimizer::read2Opcode(unsigned EltSize) const {
  if (STM->ldsRequiresM0Init())
    return (EltSize == 4) ? RVGPU::DS_READ2_B32 : RVGPU::DS_READ2_B64;
  return (EltSize == 4) ? RVGPU::DS_READ2_B32_gfx9 : RVGPU::DS_READ2_B64_gfx9;
}

unsigned SILoadStoreOptimizer::read2ST64Opcode(unsigned EltSize) const {
  if (STM->ldsRequiresM0Init())
    return (EltSize == 4) ? RVGPU::DS_READ2ST64_B32 : RVGPU::DS_READ2ST64_B64;

  return (EltSize == 4) ? RVGPU::DS_READ2ST64_B32_gfx9
                        : RVGPU::DS_READ2ST64_B64_gfx9;
}
...
SILoadStoreOptimizer::mergeRead2Pair(CombineInfo &CI, CombineInfo &Paired,
  ...
  const auto *AddrReg = TII->getNamedOperand(*CI.I, RVGPU::OpName::addr);

  const auto *Dest0 = TII->getNamedOperand(*CI.I, RVGPU::OpName::vdst);
  const auto *Dest1 = TII->getNamedOperand(*Paired.I, RVGPU::OpName::vdst);
  ...
  unsigned SubRegIdx0 = (CI.EltSize == 4) ? RVGPU::sub0 : RVGPU::sub0_sub1;
  unsigned SubRegIdx1 = (CI.EltSize == 4) ? RVGPU::sub1 : RVGPU::sub2_sub3;
  ...
  if (CI.BaseOff) {
    Register ImmReg = MRI->createVirtualRegister(&RVGPU::SReg_32RegClass);
    BuildMI(*MBB, InsertBefore, DL, TII->get(RVGPU::S_MOV_B32), ImmReg)
        .addImm(CI.BaseOff);

    BaseReg = MRI->createVirtualRegister(&RVGPU::VGPR_32RegClass);
...
unsigned SILoadStoreOptimizer::write2Opcode(unsigned EltSize) const {
  if (STM->ldsRequiresM0Init())
    return (EltSize == 4) ? RVGPU::DS_WRITE2_B32 : RVGPU::DS_WRITE2_B64;
  return (EltSize == 4) ? RVGPU::DS_WRITE2_B32_gfx9
                        : RVGPU::DS_WRITE2_B64_gfx9;
}

unsigned SILoadStoreOptimizer::write2ST64Opcode(unsigned EltSize) const {
  if (STM->ldsRequiresM0Init())
    return (EltSize == 4) ? RVGPU::DS_WRITE2ST64_B32
                          : RVGPU::DS_WRITE2ST64_B64;

  return (EltSize == 4) ? RVGPU::DS_WRITE2ST64_B32_gfx9
                        : RVGPU::DS_WRITE2ST64_B64_gfx9;
}
...
MachineBasicBlock::iterator SILoadStoreOptimizer::mergeWrite2Pair(
  ...
  const MachineOperand *AddrReg =
      TII->getNamedOperand(*CI.I, RVGPU::OpName::addr);
  const MachineOperand *Data0 =
      TII->getNamedOperand(*CI.I, RVGPU::OpName::data0);
  const MachineOperand *Data1 =
      TII->getNamedOperand(*Paired.I, RVGPU::OpName::data0);
...
SILoadStoreOptimizer::mergeImagePair(CombineInfo &CI, CombineInfo &Paired,
  ...
  unsigned DMaskIdx =
      RVGPU::getNamedOperandIdx(CI.I->getOpcode(), RVGPU::OpName::dmask);
  ...
  // Copy to the old destination registers.
  const MCInstrDesc &CopyDesc = TII->get(TargetOpcode::COPY);
  const auto *Dest0 = TII->getNamedOperand(*CI.I, RVGPU::OpName::vdata);
  const auto *Dest1 = TII->getNamedOperand(*Paired.I, RVGPU::OpName::vdata);
...
MachineBasicBlock::iterator SILoadStoreOptimizer::mergeSMemLoadImmPair(
  ...
  MachineInstrBuilder New =
      BuildMI(*MBB, InsertBefore, DL, TII->get(Opcode), DestReg)
          .add(*TII->getNamedOperand(*CI.I, RVGPU::OpName::sbase));
  if (CI.InstClass == S_BUFFER_LOAD_SGPR_IMM)
    New.add(*TII->getNamedOperand(*CI.I, RVGPU::OpName::soffset));
  ...
  // Copy to the old destination registers.
  const MCInstrDesc &CopyDesc = TII->get(TargetOpcode::COPY);
  const auto *Dest0 = TII->getNamedOperand(*CI.I, RVGPU::OpName::sdst);
  const auto *Dest1 = TII->getNamedOperand(*Paired.I, RVGPU::OpName::sdst);
...
MachineBasicBlock::iterator SILoadStoreOptimizer::mergeBufferLoadPair(
  ...
  if (Regs.VAddr)
    MIB.add(*TII->getNamedOperand(*CI.I, RVGPU::OpName::vaddr));
  ...
  MachineInstr *New =
    MIB.add(*TII->getNamedOperand(*CI.I, RVGPU::OpName::srsrc))
        .add(*TII->getNamedOperand(*CI.I, RVGPU::OpName::soffset))
...
MachineBasicBlock::iterator SILoadStoreOptimizer::mergeTBufferStorePair(
  ...
  const auto *Src0 = TII->getNamedOperand(*CI.I, RVGPU::OpName::vdata);
  const auto *Src1 = TII->getNamedOperand(*Paired.I, RVGPU::OpName::vdata);

  BuildMI(*MBB, InsertBefore, DL, TII->get(RVGPU::REG_SEQUENCE), SrcReg)
      .add(*Src0)
      .addImm(SubRegIdx0)
      .add(*Src1)
      .addImm(SubRegIdx1);
...
MachineBasicBlock::iterator SILoadStoreOptimizer::mergeFlatLoadPair(
  ...
  if (auto *SAddr = TII->getNamedOperand(*CI.I, RVGPU::OpName::saddr))
    MIB.add(*SAddr);
...
MachineBasicBlock::iterator SILoadStoreOptimizer::mergeFlatStorePair(
  ...
  auto MIB = BuildMI(*MBB, InsertBefore, DL, TII->get(Opcode))
                 .add(*TII->getNamedOperand(*CI.I, RVGPU::OpName::vaddr))
                 .addReg(SrcReg, RegState::Kill);
...
unsigned SILoadStoreOptimizer::getNewOpcode(const CombineInfo &CI,
  ...
  default:
    ...
    // FIXME: Handle d16 correctly
    return RVGPU::getMUBUFOpcode(RVGPU::getMUBUFBaseOpcode(CI.I->getOpcode()),
                                  Width);
  case TBUFFER_LOAD:
  case TBUFFER_STORE:
    return RVGPU::getMTBUFOpcode(RVGPU::getMTBUFBaseOpcode(CI.I->getOpcode()),
                                  Width);
  ...
  case S_BUFFER_LOAD_IMM:
    ...
    default:
      return 0;
    case 2:
      return RVGPU::S_BUFFER_LOAD_DWORDX2_IMM;
    case 3:
      return RVGPU::S_BUFFER_LOAD_DWORDX3_IMM;
    case 4:
      return RVGPU::S_BUFFER_LOAD_DWORDX4_IMM;
    case 8:
      return RVGPU::S_BUFFER_LOAD_DWORDX8_IMM;
    }
  case S_BUFFER_LOAD_SGPR_IMM:
    switch (Width) {
    default:
      return 0;
    case 2:
      return RVGPU::S_BUFFER_LOAD_DWORDX2_SGPR_IMM;
    case 3:
      return RVGPU::S_BUFFER_LOAD_DWORDX3_SGPR_IMM;
    case 4:
      return RVGPU::S_BUFFER_LOAD_DWORDX4_SGPR_IMM;
    case 8:
      return RVGPU::S_BUFFER_LOAD_DWORDX8_SGPR_IMM;
    }
  case S_LOAD_IMM:
    switch (Width) {
    default:
      return 0;
    case 2:
      return RVGPU::S_LOAD_DWORDX2_IMM;
    case 3:
      return RVGPU::S_LOAD_DWORDX3_IMM;
    case 4:
      return RVGPU::S_LOAD_DWORDX4_IMM;
    case 8:
      return RVGPU::S_LOAD_DWORDX8_IMM;
    }
  case GLOBAL_LOAD:
    switch (Width) {
    default:
      return 0;
    case 2:
      return RVGPU::GLOBAL_LOAD_DWORDX2;
    case 3:
      return RVGPU::GLOBAL_LOAD_DWORDX3;
    case 4:
      return RVGPU::GLOBAL_LOAD_DWORDX4;
    }
  case GLOBAL_LOAD_SADDR:
    ...
    default:
      return 0;
    case 2:
      return RVGPU::GLOBAL_LOAD_DWORDX2_SADDR;
    case 3:
      return RVGPU::GLOBAL_LOAD_DWORDX3_SADDR;
    case 4:
      return RVGPU::GLOBAL_LOAD_DWORDX4_SADDR;
    }
  case GLOBAL_STORE:
    switch (Width) {
    default:
      return 0;
    case 2:
      return RVGPU::GLOBAL_STORE_DWORDX2;
    case 3:
      return RVGPU::GLOBAL_STORE_DWORDX3;
    case 4:
      return RVGPU::GLOBAL_STORE_DWORDX4;
    }
  case GLOBAL_STORE_SADDR:
    ...
    default:
      return 0;
    case 2:
      return RVGPU::GLOBAL_STORE_DWORDX2_SADDR;
    case 3:
      return RVGPU::GLOBAL_STORE_DWORDX3_SADDR;
    case 4:
      return RVGPU::GLOBAL_STORE_DWORDX4_SADDR;
    }
  case FLAT_LOAD:
    switch (Width) {
    default:
      return 0;
    case 2:
      return RVGPU::FLAT_LOAD_DWORDX2;
    case 3:
      return RVGPU::FLAT_LOAD_DWORDX3;
    case 4:
      return RVGPU::FLAT_LOAD_DWORDX4;
    }
  case FLAT_STORE:
    switch (Width) {
    default:
      return 0;
    case 2:
      return RVGPU::FLAT_STORE_DWORDX2;
    case 3:
      return RVGPU::FLAT_STORE_DWORDX3;
    case 4:
      return RVGPU::FLAT_STORE_DWORDX4;
    }
  case MIMG:
    assert(((unsigned)llvm::popcount(CI.DMask | Paired.DMask) == Width) &&
           "No overlaps");
    return RVGPU::getMaskedMIMGOp(CI.I->getOpcode(), Width);
  }
}
...
SILoadStoreOptimizer::getSubRegIdxs(const CombineInfo &CI,
  ...
  static const unsigned Idxs[5][4] = {
      {RVGPU::sub0, RVGPU::sub0_sub1, RVGPU::sub0_sub1_sub2, RVGPU::sub0_sub1_sub2_sub3},
      {RVGPU::sub1, RVGPU::sub1_sub2, RVGPU::sub1_sub2_sub3, RVGPU::sub1_sub2_sub3_sub4},
      {RVGPU::sub2, RVGPU::sub2_sub3, RVGPU::sub2_sub3_sub4, RVGPU::sub2_sub3_sub4_sub5},
      {RVGPU::sub3, RVGPU::sub3_sub4, RVGPU::sub3_sub4_sub5, RVGPU::sub3_sub4_sub5_sub6},
      {RVGPU::sub4, RVGPU::sub4_sub5, RVGPU::sub4_sub5_sub6, RVGPU::sub4_sub5_sub6_sub7},
  };
...
SILoadStoreOptimizer::getTargetRegisterClass(const CombineInfo &CI,
  ...
  if (CI.InstClass == S_BUFFER_LOAD_IMM ||
    ...
    default:
      return nullptr;
    case 2:
      return &RVGPU::SReg_64_XEXECRegClass;
    case 3:
...
SILoadStoreOptimizer::createRegOrImm(int32_t Val, MachineInstr &MI) const {
  ...
  Register Reg = MRI->createVirtualRegister(&RVGPU::SReg_32RegClass);
  MachineInstr *Mov =
  BuildMI(*MI.getParent(), MI.getIterator(), MI.getDebugLoc(),
          TII->get(RVGPU::S_MOV_B32), Reg)
    .addImm(Val);
  (void)Mov;
...
Register SILoadStoreOptimizer::computeBase(MachineInstr &MI,
  ...
  MachineInstr *LoHalf =
    BuildMI(*MBB, MBBI, DL, TII->get(RVGPU::V_ADD_CO_U32_e64), DestSub0)
  ...
  MachineInstr *HiHalf =
  BuildMI(*MBB, MBBI, DL, TII->get(RVGPU::V_ADDC_U32_e64), DestSub1)
...
void SILoadStoreOptimizer::updateBaseAndOffset(MachineInstr &MI,
                                               Register NewBase,
                                               int32_t NewOffset) const {
  auto Base = TII->getNamedOperand(MI, RVGPU::OpName::vaddr);
  Base->setReg(NewBase);
  Base->setIsKill(false);
  TII->getNamedOperand(MI, RVGPU::OpName::offset)->setImm(NewOffset);
}
...
SILoadStoreOptimizer::extractConstOffset(const MachineOperand &Op) const {
  ...
  if (!Def || Def->getOpcode() != RVGPU::S_MOV_B32 ||
...
void SILoadStoreOptimizer::processBaseWithConstOffset(const MachineOperand &Base,
  ...
  if (!Def || Def->getOpcode() != RVGPU::REG_SEQUENCE
  ...
  if (!BaseLoDef || BaseLoDef->getOpcode() != RVGPU::V_ADD_CO_U32_e64 ||
      !BaseHiDef || BaseHiDef->getOpcode() != RVGPU::V_ADDC_U32_e64)
    return;

  const auto *Src0 = TII->getNamedOperand(*BaseLoDef, RVGPU::OpName::src0);
  const auto *Src1 = TII->getNamedOperand(*BaseLoDef, RVGPU::OpName::src1);
  ...
  Src0 = TII->getNamedOperand(*BaseHiDef, RVGPU::OpName::src0);
  Src1 = TII->getNamedOperand(*BaseHiDef, RVGPU::OpName::src1);
...
bool SILoadStoreOptimizer::promoteConstantOffsetToImm(
  ...
  if (RVGPU::getGlobalSaddrOp(MI.getOpcode()) < 0)
    return false;

  if (MI.mayLoad() &&
      TII->getNamedOperand(MI, RVGPU::OpName::vdata) != nullptr)
    return false;
  ...
  if (TII->getNamedOperand(MI, RVGPU::OpName::offset)->getImm()) {
    LLVM_DEBUG(dbgs() << "  Const-offset is already promoted.\n";);
    return false;
  }

  // Step1: Find the base-registers and a 64bit constant offset.
  MachineOperand &Base = *TII->getNamedOperand(MI, RVGPU::OpName::vaddr);
  MemAddress MAddr;
  ...
  const RVTargetLowering *TLI =
    static_cast<const RVTargetLowering *>(STM->getTargetLowering());
  ...
  for ( ; MBBI != E; ++MBBI) {
    ...
    if (MINext.getOpcode() != MI.getOpcode() ||
        TII->getNamedOperand(MINext, RVGPU::OpName::offset)->getImm())
      continue;

    const MachineOperand &BaseNext =
      *TII->getNamedOperand(MINext, RVGPU::OpName::vaddr);
