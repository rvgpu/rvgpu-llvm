...
#ifndef LLVM_LIB_TARGET_RVGPU_RVGPUMACHINEFUNCTION_H
#define LLVM_LIB_TARGET_RVGPU_RVGPUMACHINEFUNCTION_H
...
class RVGPUMachineFunction : public MachineFunctionInfo {
...
protected:
  ...
  // Functions with the rvgpu_cs_chain or rvgpu_cs_chain_preserve CC.
...
public:
  RVGPUMachineFunction(const Function &F, const RVGPUSubtarget &ST);
