...
//===----------------------------------------------------------------------===//
/// \file
/// This file declares the targeting of the RegisterBankInfo class for RVGPU.
/// \todo This should be generated by TableGen.
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_RVGPU_RVGPUREGISTERBANKINFO_H
#define LLVM_LIB_TARGET_RVGPU_RVGPUREGISTERBANKINFO_H
...
class RVGPUGenRegisterBankInfo : public RegisterBankInfo {
...
public:
  ...
  unsigned getRegBankID(Register Reg, const MachineRegisterInfo &MRI,
                        unsigned Default = RVGPU::VGPRRegBankID) const;
