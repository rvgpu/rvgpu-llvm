...
//
/// \file
/// This file does RV library function optimizations.
//
//===----------------------------------------------------------------------===//
...
#define DEBUG_TYPE "rvgpu-simplifylib"

using namespace llvm;
using namespace llvm::PatternMatch;

static cl::opt<bool> EnablePreLink("rvgpu-prelink",
  cl::desc("Enable pre-link mode optimizations"),
  cl::init(false),
  cl::Hidden);

static cl::list<std::string> UseNative("rvgpu-use-native",
...
private:
  ...
  typedef llvm::RVGPULibFunc FuncInfo;
...
static bool HasNative(RVGPULibFunc::EFuncId id) {
  switch(id) {
  case RVGPULibFunc::EI_DIVIDE:
  case RVGPULibFunc::EI_COS:
  case RVGPULibFunc::EI_EXP:
  case RVGPULibFunc::EI_EXP2:
  case RVGPULibFunc::EI_EXP10:
  case RVGPULibFunc::EI_LOG:
  case RVGPULibFunc::EI_LOG2:
  case RVGPULibFunc::EI_LOG10:
  case RVGPULibFunc::EI_POWR:
  case RVGPULibFunc::EI_RECIP:
  case RVGPULibFunc::EI_RSQRT:
  case RVGPULibFunc::EI_SIN:
  case RVGPULibFunc::EI_SINCOS:
  case RVGPULibFunc::EI_SQRT:
  case RVGPULibFunc::EI_TAN:
    return true;
  default:;
  }
  return false;
...
static TableRef getOptTable(RVGPULibFunc::EFuncId id) {
  switch(id) {
  case RVGPULibFunc::EI_ACOS:    return TableRef(tbl_acos);
  case RVGPULibFunc::EI_ACOSH:   return TableRef(tbl_acosh);
  case RVGPULibFunc::EI_ACOSPI:  return TableRef(tbl_acospi);
  case RVGPULibFunc::EI_ASIN:    return TableRef(tbl_asin);
  case RVGPULibFunc::EI_ASINH:   return TableRef(tbl_asinh);
  case RVGPULibFunc::EI_ASINPI:  return TableRef(tbl_asinpi);
  case RVGPULibFunc::EI_ATAN:    return TableRef(tbl_atan);
  case RVGPULibFunc::EI_ATANH:   return TableRef(tbl_atanh);
  case RVGPULibFunc::EI_ATANPI:  return TableRef(tbl_atanpi);
  case RVGPULibFunc::EI_CBRT:    return TableRef(tbl_cbrt);
  case RVGPULibFunc::EI_NCOS:
  case RVGPULibFunc::EI_COS:     return TableRef(tbl_cos);
  case RVGPULibFunc::EI_COSH:    return TableRef(tbl_cosh);
  case RVGPULibFunc::EI_COSPI:   return TableRef(tbl_cospi);
  case RVGPULibFunc::EI_ERFC:    return TableRef(tbl_erfc);
  case RVGPULibFunc::EI_ERF:     return TableRef(tbl_erf);
  case RVGPULibFunc::EI_EXP:     return TableRef(tbl_exp);
  case RVGPULibFunc::EI_NEXP2:
  case RVGPULibFunc::EI_EXP2:    return TableRef(tbl_exp2);
  case RVGPULibFunc::EI_EXP10:   return TableRef(tbl_exp10);
  case RVGPULibFunc::EI_EXPM1:   return TableRef(tbl_expm1);
  case RVGPULibFunc::EI_LOG:     return TableRef(tbl_log);
  case RVGPULibFunc::EI_NLOG2:
  case RVGPULibFunc::EI_LOG2:    return TableRef(tbl_log2);
  case RVGPULibFunc::EI_LOG10:   return TableRef(tbl_log10);
  case RVGPULibFunc::EI_NRSQRT:
  case RVGPULibFunc::EI_RSQRT:   return TableRef(tbl_rsqrt);
  case RVGPULibFunc::EI_NSIN:
  case RVGPULibFunc::EI_SIN:     return TableRef(tbl_sin);
  case RVGPULibFunc::EI_SINH:    return TableRef(tbl_sinh);
  case RVGPULibFunc::EI_SINPI:   return TableRef(tbl_sinpi);
  case RVGPULibFunc::EI_NSQRT:
  case RVGPULibFunc::EI_SQRT:    return TableRef(tbl_sqrt);
  case RVGPULibFunc::EI_TAN:     return TableRef(tbl_tan);
  case RVGPULibFunc::EI_TANH:    return TableRef(tbl_tanh);
  case RVGPULibFunc::EI_TANPI:   return TableRef(tbl_tanpi);
  case RVGPULibFunc::EI_TGAMMA:  return TableRef(tbl_tgamma);
  default:;
  }
  return TableRef();
}

static inline int getVecSize(const RVGPULibFunc& FInfo) {
  return FInfo.getLeads()[0].VectorSize;
}

static inline RVGPULibFunc::EType getArgType(const RVGPULibFunc& FInfo) {
  return (RVGPULibFunc::EType)FInfo.getLeads()[0].ArgType;
}

FunctionCallee RVGPULibCalls::getFunction(Module *M, const FuncInfo &fInfo) {
  // If we are doing PreLinkOpt, the function is external. So it is safe to
  // use getOrInsertFunction() at this stage.

  return EnablePreLink ? RVGPULibFunc::getOrInsertFunction(M, fInfo)
                       : RVGPULibFunc::getFunction(M, fInfo);
}

bool RVGPULibCalls::parseFunctionName(const StringRef &FMangledName,
                                       FuncInfo &FInfo) {
  return RVGPULibFunc::parse(FMangledName, FInfo);
}

bool RVGPULibCalls::isUnsafeMath(const FPMathOperator *FPOp) const {
  return UnsafeFPMath || FPOp->isFast();
}

bool RVGPULibCalls::isUnsafeFiniteOnlyMath(const FPMathOperator *FPOp) const {
  return UnsafeFPMath ||
         (FPOp->hasApproxFunc() && FPOp->hasNoNaNs() && FPOp->hasNoInfs());
}

bool RVGPULibCalls::canIncreasePrecisionOfConstantFold(
    const FPMathOperator *FPOp) const {
  // TODO: Refine to approxFunc or contract
  return isUnsafeMath(FPOp);
}

void RVGPULibCalls::initFunction(Function &F, FunctionAnalysisManager &FAM) {
...
bool RVGPULibCalls::useNativeFunc(const StringRef F) const {
  return AllNative || llvm::is_contained(UseNative, F);
}

void RVGPULibCalls::initNativeFuncs() {
  AllNative = useNativeFunc("all") ||
              (UseNative.getNumOccurrences() && UseNative.size() == 1 &&
               UseNative.begin()->empty());
}

bool RVGPULibCalls::sincosUseNative(CallInst *aCI, const FuncInfo &FInfo) {
  ...
  if (native_sin && native_cos) {
    ...
    nf.setPrefix(RVGPULibFunc::NATIVE);
    nf.setId(RVGPULibFunc::EI_SIN);
    FunctionCallee sinExpr = getFunction(M, nf);

    nf.setPrefix(RVGPULibFunc::NATIVE);
    nf.setId(RVGPULibFunc::EI_COS);
...
bool RVGPULibCalls::useNative(CallInst *aCI) {
  ...
  if (!parseFunctionName(Callee->getName(), FInfo) || !FInfo.isMangled() ||
      FInfo.getPrefix() != RVGPULibFunc::NOPFX ||
      getArgType(FInfo) == RVGPULibFunc::F64 || !HasNative(FInfo.getId()) ||
      !(AllNative || useNativeFunc(FInfo.getName()))) {
    return false;
  }

  if (FInfo.getId() == RVGPULibFunc::EI_SINCOS)
    return sincosUseNative(aCI, FInfo);

  FInfo.setPrefix(RVGPULibFunc::NATIVE);
...
bool RVGPULibCalls::fold_read_write_pipe(CallInst *CI, IRBuilder<> &B,
                                          const FuncInfo &FInfo) {
  ...
  RVGPULibFunc NewLibFunc(Name, FTy);
  FunctionCallee F = RVGPULibFunc::getOrInsertFunction(M, NewLibFunc);
  if (!F)
    return false;
...
bool RVGPULibCalls::fold(CallInst *CI) {
  ...
  LLVM_DEBUG(dbgs() << "RVIC: try folding " << *CI << '\n');
  ...
  if (FPMathOperator *FPOp = dyn_cast<FPMathOperator>(CI)) {
    ...
    case RVGPULibFunc::EI_POW: {
      Module *M = Callee->getParent();
      RVGPULibFunc PowrInfo(RVGPULibFunc::EI_POWR, FInfo);
      ...
      if (isKnownIntegral(FPOp->getOperand(1), M->getDataLayout(),
        ...
        RVGPULibFunc PownInfo(RVGPULibFunc::EI_POWN, PownType, true);
    ...
    case RVGPULibFunc::EI_POWR:
    case RVGPULibFunc::EI_POWN:
      return fold_pow(FPOp, B, FInfo);
    case RVGPULibFunc::EI_ROOTN:
    ...
    // Specialized optimizations for each function call
    switch (FInfo.getId()) {
    case RVGPULibFunc::EI_READ_PIPE_2:
    case RVGPULibFunc::EI_READ_PIPE_4:
    case RVGPULibFunc::EI_WRITE_PIPE_2:
    case RVGPULibFunc::EI_WRITE_PIPE_4:
...
bool RVGPULibCalls::TDOFold(CallInst *CI, const FuncInfo &FInfo) {
  ...
  if (getVecSize(FInfo) > 1) {
    if (ConstantDataVector *CV = dyn_cast<ConstantDataVector>(opr0)) {
      ...
      Constant *nval;
      if (getArgType(FInfo) == RVGPULibFunc::F32) {
...
bool RVGPULibCalls::fold_pow(FPMathOperator *FPOp, IRBuilder<> &B,
                              const FuncInfo &FInfo) {
  assert((FInfo.getId() == RVGPULibFunc::EI_POW ||
          FInfo.getId() == RVGPULibFunc::EI_POWR ||
          FInfo.getId() == RVGPULibFunc::EI_POWN) &&
  ...
  if ((CF && CF->isExactlyValue(1.0)) || (CINT && ci_opr1 == 1)) {
    ...
    LLVM_DEBUG(errs() << "RVIC: " << *FPOp << " ---> " << *opr0 << "\n");
  ...
  if ((CF && CF->isExactlyValue(-1.0)) || (CINT && ci_opr1 == -1)) {
    ...
    LLVM_DEBUG(errs() << "RVIC: " << *FPOp << " ---> 1 / " << *opr0 << "\n");
    Constant *cnval = ConstantFP::get(eltType, 1.0);
    if (getVecSize(FInfo) > 1) {
      cnval = ConstantDataVector::getSplat(getVecSize(FInfo), cnval);
    }
  ...
  if (CF && (CF->isExactlyValue(0.5) || CF->isExactlyValue(-0.5))) {
    ...
    if (FunctionCallee FPExpr =
            getFunction(M, RVGPULibFunc(issqrt ? RVGPULibFunc::EI_SQRT
                                                : RVGPULibFunc::EI_RSQRT,
                                         FInfo))) {
      LLVM_DEBUG(errs() << "RVIC: " << *FPOp << " ---> " << FInfo.getName()
                        << '(' << *opr0 << ")\n");
  ...
  if (CF) {
    double dval = (getArgType(FInfo) == RVGPULibFunc::F32)
  ...
  if (ShouldUseIntrinsic)
    ...
    ExpExpr = getFunction(M, RVGPULibFunc(RVGPULibFunc::EI_EXP2, FInfo));
    if (!ExpExpr)
      return false;
  }
  ...
  if (getVecSize(FInfo) == 1) {
    ...
    if (CF) {
      double V = (getArgType(FInfo) == RVGPULibFunc::F32)
                     ? (double)CF->convertToFloat()
                     : CF->convertToDouble();

      V = log2(std::abs(V));
      cnval = ConstantFP::get(eltType, V);
      needcopysign = (FInfo.getId() != RVGPULibFunc::EI_POWR) &&
                     CF->isNegative();
    } else {
      needlog = true;
      needcopysign = needabs = FInfo.getId() != RVGPULibFunc::EI_POWR;
    }
  } else {
  ...
  if (needcopysign && (FInfo.getId() == RVGPULibFunc::EI_POW)) {
  ...
  if (needlog) {
    ...
    if (ShouldUseIntrinsic) {
      ...
      LogExpr = getFunction(M, RVGPULibFunc(RVGPULibFunc::EI_LOG2, FInfo));
      if (!LogExpr)
        return false;
    }
  ...
  if (FInfo.getId() == RVGPULibFunc::EI_POWN) {
...
bool RVGPULibCalls::fold_rootn(FPMathOperator *FPOp, IRBuilder<> &B,
                                const FuncInfo &FInfo) {
  ...
  if (ci_opr1 == 2) { // rootn(x, 2) = sqrt(x)
    if (FunctionCallee FPExpr =
            getFunction(M, RVGPULibFunc(RVGPULibFunc::EI_SQRT, FInfo))) {
      LLVM_DEBUG(errs() << "RVIC: " << *FPOp << " ---> sqrt(" << *opr0
                        << ")\n");
    ...
    if (FunctionCallee FPExpr =
            getFunction(M, RVGPULibFunc(RVGPULibFunc::EI_CBRT, FInfo))) {
      LLVM_DEBUG(errs() << "RVIC: " << *FPOp << " ---> cbrt(" << *opr0
                        << ")\n");
    ...
    LLVM_DEBUG(errs() << "RVIC: " << *FPOp << " ---> 1.0 / " << *opr0 << "\n");
    ...
    if (FunctionCallee FPExpr =
            getFunction(M, RVGPULibFunc(RVGPULibFunc::EI_RSQRT, FInfo))) {
      LLVM_DEBUG(errs() << "RVIC: " << *FPOp << " ---> rsqrt(" << *opr0
                        << ")\n");
...
// Get a scalar native builtin single argument FP function
FunctionCallee RVGPULibCalls::getNativeFunction(Module *M,
                                                 const FuncInfo &FInfo) {
  if (getArgType(FInfo) == RVGPULibFunc::F64 || !HasNative(FInfo.getId()))
    return nullptr;
  FuncInfo nf = FInfo;
  nf.setPrefix(RVGPULibFunc::NATIVE);
...
bool RVGPULibCalls::shouldReplaceLibcallWithIntrinsic(const CallInst *CI,
...
void RVGPULibCalls::replaceLibCallWithSimpleIntrinsic(IRBuilder<> &B,
                                                       CallInst *CI,
                                                       Intrinsic::ID IntrID) {
  if (CI->arg_size() == 2) {
...
bool RVGPULibCalls::tryReplaceLibcallWithSimpleIntrinsic(
...
bool RVGPULibCalls::fold_sqrt(FPMathOperator *FPOp, IRBuilder<> &B,
                               const FuncInfo &FInfo) {
  if (!isUnsafeMath(FPOp))
    return false;

  if (getArgType(FInfo) == RVGPULibFunc::F32 && (getVecSize(FInfo) == 1) &&
      (FInfo.getPrefix() != RVGPULibFunc::NATIVE)) {
    Module *M = B.GetInsertBlock()->getModule();

    if (FunctionCallee FPExpr = getNativeFunction(
            M, RVGPULibFunc(RVGPULibFunc::EI_SQRT, FInfo))) {
      Value *opr0 = FPOp->getOperand(0);
      LLVM_DEBUG(errs() << "RVIC: " << *FPOp << " ---> "
                        << "sqrt(" << *opr0 << ")\n");
...
RVGPULibCalls::insertSinCos(Value *Arg, FastMathFlags FMF, IRBuilder<> &B,
                             FunctionCallee Fsincos) {
...
// fold sin, cos -> sincos.
bool RVGPULibCalls::fold_sincos(FPMathOperator *FPOp, IRBuilder<> &B,
                                 const FuncInfo &fInfo) {
  assert(fInfo.getId() == RVGPULibFunc::EI_SIN ||
         fInfo.getId() == RVGPULibFunc::EI_COS);

  if ((getArgType(fInfo) != RVGPULibFunc::F32 &&
       getArgType(fInfo) != RVGPULibFunc::F64) ||
      fInfo.getPrefix() != RVGPULibFunc::NOPFX)
    return false;

  bool const isSin = fInfo.getId() == RVGPULibFunc::EI_SIN;
  ...
  RVGPULibFunc SinCosLibFuncPrivate(RVGPULibFunc::EI_SINCOS, fInfo);
  SinCosLibFuncPrivate.getLeads()[0].PtrKind =
      RVGPULibFunc::getEPtrKindFromAddrSpace(RVGPUAS::PRIVATE_ADDRESS);

  RVGPULibFunc SinCosLibFuncGeneric(RVGPULibFunc::EI_SINCOS, fInfo);
  SinCosLibFuncGeneric.getLeads()[0].PtrKind =
      RVGPULibFunc::getEPtrKindFromAddrSpace(RVGPUAS::FLAT_ADDRESS);
  ...
  FuncInfo PartnerInfo(isSin ? RVGPULibFunc::EI_COS : RVGPULibFunc::EI_SIN,
                       fInfo);
...
bool RVGPULibCalls::evaluateScalarMathFunc(const FuncInfo &FInfo, double &Res0,
  ...
  if (fpopr0) {
    opr0 = (getArgType(FInfo) == RVGPULibFunc::F64)
             ? fpopr0->getValueAPF().convertToDouble()
             : (double)fpopr0->getValueAPF().convertToFloat();
  }

  if (fpopr1) {
    opr1 = (getArgType(FInfo) == RVGPULibFunc::F64)
  ...
  case RVGPULibFunc::EI_ACOS:
    Res0 = acos(opr0);
    return true;

  case RVGPULibFunc::EI_ACOSH:
    // acosh(x) == log(x + sqrt(x*x - 1))
    Res0 = log(opr0 + sqrt(opr0*opr0 - 1.0));
    return true;

  case RVGPULibFunc::EI_ACOSPI:
    Res0 = acos(opr0) / MATH_PI;
    return true;

  case RVGPULibFunc::EI_ASIN:
    Res0 = asin(opr0);
    return true;

  case RVGPULibFunc::EI_ASINH:
    // asinh(x) == log(x + sqrt(x*x + 1))
    Res0 = log(opr0 + sqrt(opr0*opr0 + 1.0));
    return true;

  case RVGPULibFunc::EI_ASINPI:
    Res0 = asin(opr0) / MATH_PI;
    return true;

  case RVGPULibFunc::EI_ATAN:
    Res0 = atan(opr0);
    return true;

  case RVGPULibFunc::EI_ATANH:
    // atanh(x) == (log(x+1) - log(x-1))/2;
    Res0 = (log(opr0 + 1.0) - log(opr0 - 1.0))/2.0;
    return true;

  case RVGPULibFunc::EI_ATANPI:
    Res0 = atan(opr0) / MATH_PI;
    return true;

  case RVGPULibFunc::EI_CBRT:
  ...
  case RVGPULibFunc::EI_COSH:
    Res0 = cosh(opr0);
    return true;

  case RVGPULibFunc::EI_COSPI:
  ...
  case RVGPULibFunc::EI_SINH:
    Res0 = sinh(opr0);
    return true;

  case RVGPULibFunc::EI_SINPI:
  ...
  case RVGPULibFunc::EI_TANH:
    Res0 = tanh(opr0);
    return true;

  case RVGPULibFunc::EI_TANPI:
...
bool RVGPULibCalls::evaluateCall(CallInst *aCI, const FuncInfo &FInfo) {
  ...
  bool hasTwoResults = (FInfo.getId() == RVGPULibFunc::EI_SINCOS);
  if (FuncVecSize == 1) {
  ...
  if (hasTwoResults) {
    // sincos
    assert(FInfo.getId() == RVGPULibFunc::EI_SINCOS &&
...
PreservedAnalyses RVGPUSimplifyLibCallsPass::run(Function &F,
                                                  FunctionAnalysisManager &AM) {
  RVGPULibCalls Simplifier;
  Simplifier.initNativeFuncs();
  Simplifier.initFunction(F, AM);

  bool Changed = false;

  LLVM_DEBUG(dbgs() << "RVIC: process function ";
...
PreservedAnalyses RVGPUUseNativeCallsPass::run(Function &F,
                                                FunctionAnalysisManager &AM) {
  if (UseNative.empty())
