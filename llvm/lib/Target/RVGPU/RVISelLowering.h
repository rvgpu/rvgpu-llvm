//===-- RVISelLowering.h - SI DAG Lowering Interface ------------*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_RVGPU_SIISELLOWERING_H
#define LLVM_LIB_TARGET_RVGPU_SIISELLOWERING_H
...
private:
  ...
  SDValue getPreloadedValue(SelectionDAG &DAG,
                            ...
                            EVT VT,
                            RVGPUFunctionArgInfo::PreloadedValue) const;

  SDValue LowerGlobalAddress(RVGPUMachineFunction *MFI, SDValue Op,
                             SelectionDAG &DAG) const override;
  SDValue lowerImplicitZextParam(SelectionDAG &DAG, SDValue Op,
                                 MVT VT, unsigned Offset) const;
  SDValue lowerImage(SDValue Op, const RVGPU::ImageDimIntrinsicInfo *Intr,
