//===-- RVGPUKernelCodeT.h - Print RVGPU assembly code ---------*- C++ -*-===//
//
...
//---------------------------------------------------------------------------//
// RV Kernel Code, and its dependencies                                     //
//---------------------------------------------------------------------------//
...
/// The version of the rv_*_code_t struct. Minor versions must be
/// backward compatible.
typedef uint32_t rv_code_version32_t;
enum rv_code_version_t {
  RV_CODE_VERSION_MAJOR = 0,
  RV_CODE_VERSION_MINOR = 1
};
