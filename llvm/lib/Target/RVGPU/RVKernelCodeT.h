//===-- RVKernelCodeT.h - Print RVGPU assembly code ---------*- C++ -*-===//
//
...
//
//===----------------------------------------------------------------------===//
/// \file RVKernelCodeT.h
//===----------------------------------------------------------------------===//

#ifndef RVKERNELCODET_H
#define RVKERNELCODET_H

#include <cstdint>

//---------------------------------------------------------------------------//
// RVGPU Kernel Code, and its dependencies                                     //
//---------------------------------------------------------------------------//
...
/// The version of the rvgpu_*_code_t struct. Minor versions must be
/// backward compatible.
typedef uint32_t rvgpu_code_version32_t;
enum rvgpu_code_version_t {
  RVGPU_CODE_VERSION_MAJOR = 0,
  RVGPU_CODE_VERSION_MINOR = 1
};

// Sets val bits for specified mask in specified dst packed instance.
#define RV_HSA_BITS_SET(dst, mask, val)                                       \
  dst &= (~(1 << mask ## _SHIFT) & ~mask);                                     \
  dst |= (((val) << mask ## _SHIFT) & mask)

// Gets bits for specified mask from specified src packed instance.
#define RV_HSA_BITS_GET(src, mask)                                            \
  ((src & mask) >> mask ## _SHIFT)                                             \

/// The values used to define the number of bytes to use for the
/// swizzle element size.
enum rv_element_byte_size_t {
  RV_ELEMENT_2_BYTES = 0,
  RV_ELEMENT_4_BYTES = 1,
  RV_ELEMENT_8_BYTES = 2,
  RV_ELEMENT_16_BYTES = 3
};

/// Shader program settings for CS. Contains COMPUTE_PGM_RSRC1 and
/// COMPUTE_PGM_RSRC2 registers.
typedef uint64_t rv_compute_pgm_resource_register64_t;

/// Every RV_*_code_t has the following properties, which are composed of
/// a number of bit fields. Every bit field has a mask (RV_CODE_PROPERTY_*),
/// bit width (RV_CODE_PROPERTY_*_WIDTH, and bit shift amount
/// (RV_CODE_PROPERTY_*_SHIFT) for convenient access. Unused bits must be 0.
///
/// (Note that bit fields cannot be used as their layout is
/// implementation defined in the C standard and so cannot be used to
/// specify an ABI)
typedef uint32_t rv_code_property32_t;
enum rv_code_property_mask_t {

  /// Enable the setup of the SGPR user data registers
  /// (RV_CODE_PROPERTY_ENABLE_SGPR_*), see documentation of rv_kernel_code_t
  ...
  RV_CODE_PROPERTY_ENABLE_SGPR_PRIVATE_SEGMENT_BUFFER_SHIFT = 0,
  RV_CODE_PROPERTY_ENABLE_SGPR_PRIVATE_SEGMENT_BUFFER_WIDTH = 1,
  RV_CODE_PROPERTY_ENABLE_SGPR_PRIVATE_SEGMENT_BUFFER = ((1 << RV_CODE_PROPERTY_ENABLE_SGPR_PRIVATE_SEGMENT_BUFFER_WIDTH) - 1) << RV_CODE_PROPERTY_ENABLE_SGPR_PRIVATE_SEGMENT_BUFFER_SHIFT,

  RV_CODE_PROPERTY_ENABLE_SGPR_DISPATCH_PTR_SHIFT = 1,
  RV_CODE_PROPERTY_ENABLE_SGPR_DISPATCH_PTR_WIDTH = 1,
  RV_CODE_PROPERTY_ENABLE_SGPR_DISPATCH_PTR = ((1 << RV_CODE_PROPERTY_ENABLE_SGPR_DISPATCH_PTR_WIDTH) - 1) << RV_CODE_PROPERTY_ENABLE_SGPR_DISPATCH_PTR_SHIFT,

  RV_CODE_PROPERTY_ENABLE_SGPR_QUEUE_PTR_SHIFT = 2,
  RV_CODE_PROPERTY_ENABLE_SGPR_QUEUE_PTR_WIDTH = 1,
  RV_CODE_PROPERTY_ENABLE_SGPR_QUEUE_PTR = ((1 << RV_CODE_PROPERTY_ENABLE_SGPR_QUEUE_PTR_WIDTH) - 1) << RV_CODE_PROPERTY_ENABLE_SGPR_QUEUE_PTR_SHIFT,

  RV_CODE_PROPERTY_ENABLE_SGPR_KERNARG_SEGMENT_PTR_SHIFT = 3,
  RV_CODE_PROPERTY_ENABLE_SGPR_KERNARG_SEGMENT_PTR_WIDTH = 1,
  RV_CODE_PROPERTY_ENABLE_SGPR_KERNARG_SEGMENT_PTR = ((1 << RV_CODE_PROPERTY_ENABLE_SGPR_KERNARG_SEGMENT_PTR_WIDTH) - 1) << RV_CODE_PROPERTY_ENABLE_SGPR_KERNARG_SEGMENT_PTR_SHIFT,

  RV_CODE_PROPERTY_ENABLE_SGPR_DISPATCH_ID_SHIFT = 4,
  RV_CODE_PROPERTY_ENABLE_SGPR_DISPATCH_ID_WIDTH = 1,
  RV_CODE_PROPERTY_ENABLE_SGPR_DISPATCH_ID = ((1 << RV_CODE_PROPERTY_ENABLE_SGPR_DISPATCH_ID_WIDTH) - 1) << RV_CODE_PROPERTY_ENABLE_SGPR_DISPATCH_ID_SHIFT,

  RV_CODE_PROPERTY_ENABLE_SGPR_FLAT_SCRATCH_INIT_SHIFT = 5,
  RV_CODE_PROPERTY_ENABLE_SGPR_FLAT_SCRATCH_INIT_WIDTH = 1,
  RV_CODE_PROPERTY_ENABLE_SGPR_FLAT_SCRATCH_INIT = ((1 << RV_CODE_PROPERTY_ENABLE_SGPR_FLAT_SCRATCH_INIT_WIDTH) - 1) << RV_CODE_PROPERTY_ENABLE_SGPR_FLAT_SCRATCH_INIT_SHIFT,

  RV_CODE_PROPERTY_ENABLE_SGPR_PRIVATE_SEGMENT_SIZE_SHIFT = 6,
  RV_CODE_PROPERTY_ENABLE_SGPR_PRIVATE_SEGMENT_SIZE_WIDTH = 1,
  RV_CODE_PROPERTY_ENABLE_SGPR_PRIVATE_SEGMENT_SIZE = ((1 << RV_CODE_PROPERTY_ENABLE_SGPR_PRIVATE_SEGMENT_SIZE_WIDTH) - 1) << RV_CODE_PROPERTY_ENABLE_SGPR_PRIVATE_SEGMENT_SIZE_SHIFT,

  RV_CODE_PROPERTY_ENABLE_SGPR_GRID_WORKGROUP_COUNT_X_SHIFT = 7,
  RV_CODE_PROPERTY_ENABLE_SGPR_GRID_WORKGROUP_COUNT_X_WIDTH = 1,
  RV_CODE_PROPERTY_ENABLE_SGPR_GRID_WORKGROUP_COUNT_X = ((1 << RV_CODE_PROPERTY_ENABLE_SGPR_GRID_WORKGROUP_COUNT_X_WIDTH) - 1) << RV_CODE_PROPERTY_ENABLE_SGPR_GRID_WORKGROUP_COUNT_X_SHIFT,

  RV_CODE_PROPERTY_ENABLE_SGPR_GRID_WORKGROUP_COUNT_Y_SHIFT = 8,
  RV_CODE_PROPERTY_ENABLE_SGPR_GRID_WORKGROUP_COUNT_Y_WIDTH = 1,
  RV_CODE_PROPERTY_ENABLE_SGPR_GRID_WORKGROUP_COUNT_Y = ((1 << RV_CODE_PROPERTY_ENABLE_SGPR_GRID_WORKGROUP_COUNT_Y_WIDTH) - 1) << RV_CODE_PROPERTY_ENABLE_SGPR_GRID_WORKGROUP_COUNT_Y_SHIFT,

  RV_CODE_PROPERTY_ENABLE_SGPR_GRID_WORKGROUP_COUNT_Z_SHIFT = 9,
  RV_CODE_PROPERTY_ENABLE_SGPR_GRID_WORKGROUP_COUNT_Z_WIDTH = 1,
  RV_CODE_PROPERTY_ENABLE_SGPR_GRID_WORKGROUP_COUNT_Z = ((1 << RV_CODE_PROPERTY_ENABLE_SGPR_GRID_WORKGROUP_COUNT_Z_WIDTH) - 1) << RV_CODE_PROPERTY_ENABLE_SGPR_GRID_WORKGROUP_COUNT_Z_SHIFT,

  RV_CODE_PROPERTY_ENABLE_WAVEFRONT_SIZE32_SHIFT = 10,
  RV_CODE_PROPERTY_ENABLE_WAVEFRONT_SIZE32_WIDTH = 1,
  RV_CODE_PROPERTY_ENABLE_WAVEFRONT_SIZE32 = ((1 << RV_CODE_PROPERTY_ENABLE_WAVEFRONT_SIZE32_WIDTH) - 1) << RV_CODE_PROPERTY_ENABLE_WAVEFRONT_SIZE32_SHIFT,

  RV_CODE_PROPERTY_RESERVED1_SHIFT = 11,
  RV_CODE_PROPERTY_RESERVED1_WIDTH = 5,
  RV_CODE_PROPERTY_RESERVED1 = ((1 << RV_CODE_PROPERTY_RESERVED1_WIDTH) - 1) << RV_CODE_PROPERTY_RESERVED1_SHIFT,
  ...
  RV_CODE_PROPERTY_ENABLE_ORDERED_APPEND_GDS_SHIFT = 16,
  RV_CODE_PROPERTY_ENABLE_ORDERED_APPEND_GDS_WIDTH = 1,
  RV_CODE_PROPERTY_ENABLE_ORDERED_APPEND_GDS = ((1 << RV_CODE_PROPERTY_ENABLE_ORDERED_APPEND_GDS_WIDTH) - 1) << RV_CODE_PROPERTY_ENABLE_ORDERED_APPEND_GDS_SHIFT,
  ...
  /// is generally DWORD.
  ///
  /// uSE VALUES FROM THE RV_ELEMENT_BYTE_SIZE_T ENUM.
  RV_CODE_PROPERTY_PRIVATE_ELEMENT_SIZE_SHIFT = 17,
  RV_CODE_PROPERTY_PRIVATE_ELEMENT_SIZE_WIDTH = 2,
  RV_CODE_PROPERTY_PRIVATE_ELEMENT_SIZE = ((1 << RV_CODE_PROPERTY_PRIVATE_ELEMENT_SIZE_WIDTH) - 1) << RV_CODE_PROPERTY_PRIVATE_ELEMENT_SIZE_SHIFT,

  /// Are global memory addresses 64 bits. Must match
  /// rv_kernel_code_t.hsail_machine_model ==
  /// HSA_MACHINE_LARGE. Must also match
  /// SH_MEM_CONFIG.PTR32 (GFX6 (SI)/GFX7 (CI)),
  /// SH_MEM_CONFIG.ADDRESS_MODE (GFX8 (VI)+).
  RV_CODE_PROPERTY_IS_PTR64_SHIFT = 19,
  RV_CODE_PROPERTY_IS_PTR64_WIDTH = 1,
  RV_CODE_PROPERTY_IS_PTR64 = ((1 << RV_CODE_PROPERTY_IS_PTR64_WIDTH) - 1) << RV_CODE_PROPERTY_IS_PTR64_SHIFT,
  ...
  /// for the call stack.
  RV_CODE_PROPERTY_IS_DYNAMIC_CALLSTACK_SHIFT = 20,
  RV_CODE_PROPERTY_IS_DYNAMIC_CALLSTACK_WIDTH = 1,
  RV_CODE_PROPERTY_IS_DYNAMIC_CALLSTACK = ((1 << RV_CODE_PROPERTY_IS_DYNAMIC_CALLSTACK_WIDTH) - 1) << RV_CODE_PROPERTY_IS_DYNAMIC_CALLSTACK_SHIFT,

  /// Indicate if code generated has support for debugging.
  RV_CODE_PROPERTY_IS_DEBUG_SUPPORTED_SHIFT = 21,
  RV_CODE_PROPERTY_IS_DEBUG_SUPPORTED_WIDTH = 1,
  RV_CODE_PROPERTY_IS_DEBUG_SUPPORTED = ((1 << RV_CODE_PROPERTY_IS_DEBUG_SUPPORTED_WIDTH) - 1) << RV_CODE_PROPERTY_IS_DEBUG_SUPPORTED_SHIFT,

  RV_CODE_PROPERTY_IS_XNACK_SUPPORTED_SHIFT = 22,
  RV_CODE_PROPERTY_IS_XNACK_SUPPORTED_WIDTH = 1,
  RV_CODE_PROPERTY_IS_XNACK_SUPPORTED = ((1 << RV_CODE_PROPERTY_IS_XNACK_SUPPORTED_WIDTH) - 1) << RV_CODE_PROPERTY_IS_XNACK_SUPPORTED_SHIFT,

  RV_CODE_PROPERTY_RESERVED2_SHIFT = 23,
  RV_CODE_PROPERTY_RESERVED2_WIDTH = 9,
  RV_CODE_PROPERTY_RESERVED2 = ((1 << RV_CODE_PROPERTY_RESERVED2_WIDTH) - 1) << RV_CODE_PROPERTY_RESERVED2_SHIFT
};
...
/// RV Kernel Code Object (rv_kernel_code_t). GPU CP uses the RV Kernel
...
/// which ones are actually setup in the rv_kernel_code_t object using the
...
///       agree with rv_kernel_code_t.privateElementSize)
...
///       rv_kernel_code_t.wavefrontSize)
///     - Add tid enable: 1
...
///   Number of User SGPR registers: 2. 64 bit address of RVQueue object for
...
///     rv_kernel_code_t.globalMemoryCoherence
///
...
struct rv_kernel_code_t {
  uint32_t rv_kernel_code_version_major;
  uint32_t rv_kernel_code_version_minor;
  uint16_t rv_machine_kind;
  uint16_t rv_machine_version_major;
  uint16_t rv_machine_version_minor;
  uint16_t rv_machine_version_stepping;

  /// Byte offset (possibly negative) from start of rv_kernel_code_t
  ...
  /// independent code (PIC) for RV devices to give runtime the
  ...
  /// rv_kernel_code_t object. Set both to 0 if no prefetch
  ...
  /// Code properties. See RV_code_property_mask_t for a full list of
  /// properties.
