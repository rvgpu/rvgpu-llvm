...
#ifndef LLVM_LIB_TARGET_RVGPUHAZARDRECOGNIZERS_H
#define LLVM_LIB_TARGET_RVGPUHAZARDRECOGNIZERS_H
...
private:
  ...
  /// line option '-rvgpu-mfma-padding-ratio'.
  ///
  /// For example, with '-rvgpu-mfma-padding-ratio=100':
  ///
...
#endif //LLVM_LIB_TARGET_RVGPUHAZARDRECOGNIZERS_H
