//=== lib/CodeGen/GlobalISel/RVGPUCombinerHelper.h -------------*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_RVGPU_RVGPUCOMBINERHELPER_H
#define LLVM_LIB_TARGET_RVGPU_RVGPUCOMBINERHELPER_H
...
class RVGPUCombinerHelper : public CombinerHelper {
public:
...
#endif // LLVM_LIB_TARGET_RVGPU_RVGPUCOMBINERHELPER_H
