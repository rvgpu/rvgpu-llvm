//===- RVGPUMachineCFGStructurizer.cpp - Machine code if conversion pass. ===//
//
...
#define DEBUG_TYPE "rvgpucfgstructurizer"
...
static unsigned createBBSelectReg(const RVInstrInfo *TII,
                                  MachineRegisterInfo *MRI) {
...
RegionMRT *MRT::buildMRT(MachineFunction &MF,
                         const MachineRegionInfo *RegionInfo,
                         const RVInstrInfo *TII, MachineRegisterInfo *MRI) {
...
class RVGPUMachineCFGStructurizer : public MachineFunctionPass {
private:
...
public:
  ...
  RVGPUMachineCFGStructurizer() : MachineFunctionPass(ID) {
    initializeRVGPUMachineCFGStructurizerPass(*PassRegistry::getPassRegistry());
  }
...
char RVGPUMachineCFGStructurizer::ID = 0;

bool RVGPUMachineCFGStructurizer::regionIsSimpleIf(RegionMRT *Region) {
...
void RVGPUMachineCFGStructurizer::transformSimpleIfRegion(RegionMRT *Region) {
  MachineBasicBlock *Entry = Region->getEntry();
...
void RVGPUMachineCFGStructurizer::getPHIRegionIndices(
...
void RVGPUMachineCFGStructurizer::getPHINonRegionIndices(
    LinearizedRegion *Region, MachineInstr &PHI,
    SmallVector<unsigned, 2> &PHINonRegionIndices) {
  unsigned NumInputs = getPHINumInputs(PHI);
  for (unsigned i = 0; i < NumInputs; ++i) {
...
void RVGPUMachineCFGStructurizer::storePHILinearizationInfoDest(
    unsigned LDestReg, MachineInstr &PHI,
    SmallVector<unsigned, 2> *RegionIndices) {
  if (RegionIndices) {
...
unsigned RVGPUMachineCFGStructurizer::storePHILinearizationInfo(
...
void RVGPUMachineCFGStructurizer::extractKilledPHIs(MachineBasicBlock *MBB) {
...
bool RVGPUMachineCFGStructurizer::shrinkPHI(MachineInstr &PHI,
...
void RVGPUMachineCFGStructurizer::replacePHI(
...
void RVGPUMachineCFGStructurizer::replaceEntryPHI(
...
void RVGPUMachineCFGStructurizer::replaceLiveOutRegs(
...
void RVGPUMachineCFGStructurizer::rewriteRegionExitPHI(RegionMRT *Region,
                                                  MachineBasicBlock *LastMerge,
                                                  MachineInstr &PHI,
                                                  LinearizedRegion *LRegion) {
  SmallVector<unsigned, 2> PHIRegionIndices;
...
void RVGPUMachineCFGStructurizer::rewriteRegionEntryPHI(LinearizedRegion *Region,
                                                   MachineBasicBlock *IfMBB,
                                                   MachineInstr &PHI) {
  SmallVector<unsigned, 2> PHINonRegionIndices;
...
void RVGPUMachineCFGStructurizer::rewriteRegionExitPHIs(RegionMRT *Region,
                                                   MachineBasicBlock *LastMerge,
                                                   LinearizedRegion *LRegion) {
  SmallVector<MachineInstr *, 2> PHIs;
...
void RVGPUMachineCFGStructurizer::rewriteRegionEntryPHIs(LinearizedRegion *Region,
                                                    MachineBasicBlock *IfMBB) {
  SmallVector<MachineInstr *, 2> PHIs;
...
void RVGPUMachineCFGStructurizer::insertUnconditionalBranch(MachineBasicBlock *MBB,
                                                       MachineBasicBlock *Dest,
                                                       const DebugLoc &DL) {
...
MachineBasicBlock *
RVGPUMachineCFGStructurizer::createLinearizedExitBlock(RegionMRT *Region) {
  auto Exit = Region->getSucc();
...
void RVGPUMachineCFGStructurizer::insertMergePHI(MachineBasicBlock *IfBB,
                                            MachineBasicBlock *CodeBB,
                                            MachineBasicBlock *MergeBB,
...
MachineBasicBlock *RVGPUMachineCFGStructurizer::createIfBlock(
...
void RVGPUMachineCFGStructurizer::ensureCondIsNotKilled(
...
void RVGPUMachineCFGStructurizer::rewriteCodeBBTerminator(MachineBasicBlock *CodeBB,
                                                     MachineBasicBlock *MergeBB,
                                                     unsigned BBSelectReg) {
...
MachineInstr *RVGPUMachineCFGStructurizer::getDefInstr(unsigned Reg) {
  if (MRI->def_begin(Reg) == MRI->def_end()) {
    LLVM_DEBUG(dbgs() << "Register "
                      << printReg(Reg, MRI->getTargetRegisterInfo())
                      << " has NO defs\n");
...
void RVGPUMachineCFGStructurizer::insertChainedPHI(MachineBasicBlock *IfBB,
                                              MachineBasicBlock *CodeBB,
                                              MachineBasicBlock *MergeBB,
                                              LinearizedRegion *InnerRegion,
                                              unsigned DestReg,
...
bool RVGPUMachineCFGStructurizer::containsDef(MachineBasicBlock *MBB,
                                         LinearizedRegion *InnerRegion,
                                         unsigned Register) {
...
void RVGPUMachineCFGStructurizer::rewriteLiveOutRegs(MachineBasicBlock *IfBB,
                                                MachineBasicBlock *CodeBB,
                                                MachineBasicBlock *MergeBB,
                                                LinearizedRegion *InnerRegion,
                                                LinearizedRegion *LRegion) {
...
void RVGPUMachineCFGStructurizer::prunePHIInfo(MachineBasicBlock *MBB) {
...
void RVGPUMachineCFGStructurizer::createEntryPHI(LinearizedRegion *CurrentRegion,
                                            unsigned DestReg) {
...
void RVGPUMachineCFGStructurizer::createEntryPHIs(LinearizedRegion *CurrentRegion) {
  LLVM_DEBUG(PHIInfo.dump(MRI));
...
void RVGPUMachineCFGStructurizer::replaceRegisterWith(
...
void RVGPUMachineCFGStructurizer::resolvePHIInfos(MachineBasicBlock *FunctionEntry) {
...
MachineBasicBlock *RVGPUMachineCFGStructurizer::createIfRegion(
...
void RVGPUMachineCFGStructurizer::splitLoopPHI(MachineInstr &PHI,
                                          MachineBasicBlock *Entry,
...
void RVGPUMachineCFGStructurizer::splitLoopPHIs(MachineBasicBlock *Entry,
                                           MachineBasicBlock *EntrySucc,
                                           LinearizedRegion *LRegion) {
  SmallVector<MachineInstr *, 2> PHIs;
  collectPHIs(Entry, PHIs);
...
MachineBasicBlock *
RVGPUMachineCFGStructurizer::splitExit(LinearizedRegion *LRegion) {
...
MachineBasicBlock *
RVGPUMachineCFGStructurizer::splitEntry(LinearizedRegion *LRegion) {
...
LinearizedRegion *
RVGPUMachineCFGStructurizer::initLinearizedRegion(RegionMRT *Region) {
  LinearizedRegion *LRegion = Region->getLinearizedRegion();
...
bool RVGPUMachineCFGStructurizer::structurizeComplexRegion(RegionMRT *Region) {
...
bool RVGPUMachineCFGStructurizer::structurizeRegion(RegionMRT *Region) {
...
bool RVGPUMachineCFGStructurizer::structurizeRegions(RegionMRT *Region,
                                                bool isTopRegion) {
  bool Changed = false;
...
void RVGPUMachineCFGStructurizer::initFallthroughMap(MachineFunction &MF) {
...
void RVGPUMachineCFGStructurizer::createLinearizedRegion(RegionMRT *Region,
                                                    unsigned SelectOut) {
...
unsigned
RVGPUMachineCFGStructurizer::initializeSelectRegisters(MRT *MRT, unsigned SelectOut,
                                                  MachineRegisterInfo *MRI,
                                                  const RVInstrInfo *TII) {
  if (MRT->isRegion()) {
...
char RVGPUMachineCFGStructurizerID = RVGPUMachineCFGStructurizer::ID;

INITIALIZE_PASS_BEGIN(RVGPUMachineCFGStructurizer, "rvgpu-machine-cfg-structurizer",
                      "RVGPU Machine CFG Structurizer", false, false)
INITIALIZE_PASS_DEPENDENCY(MachineRegionInfoPass)
INITIALIZE_PASS_END(RVGPUMachineCFGStructurizer, "rvgpu-machine-cfg-structurizer",
                    "RVGPU Machine CFG Structurizer", false, false)

FunctionPass *llvm::createRVGPUMachineCFGStructurizerPass() {
  return new RVGPUMachineCFGStructurizer();
}
