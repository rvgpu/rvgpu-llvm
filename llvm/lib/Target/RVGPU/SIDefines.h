...
#ifndef LLVM_LIB_TARGET_RVGPU_SIDEFINES_H
#define LLVM_LIB_TARGET_RVGPU_SIDEFINES_H
...
// This must be kept in sync with the SIEncodingFamily class in RVInstrInfo.td
...
enum Id { // Message ID, width(4) [3:0].
  ...
  ID_GS_PreR1000 = 2,      // replaced in R1000
  ID_GS_DONE_PreR1000 = 3, // replaced in R1000

  ID_HS_TESSFACTOR_R1000Plus = 2, // reused in R1000
  ID_DEALLOC_VGPRS_R1000Plus = 3, // reused in R1000

  ID_SAVEWAVE = 4,           // added in GFX8, removed in R1000
  ID_STALL_WAVE_GEN = 5,     // added in GFX9, removed in GFX12
  ID_HALT_WAVES = 6,         // added in GFX9, removed in GFX12
  ID_ORDERED_PS_DONE = 7,    // added in GFX9, removed in R1000
  ID_EARLY_PRIM_DEALLOC = 8, // added in GFX9, removed in GFX10
  ID_GS_ALLOC_REQ = 9,       // added in GFX9
  ID_GET_DOORBELL = 10,      // added in GFX9, removed in R1000
  ID_GET_DDID = 11,          // added in GFX10, removed in R1000
  ID_SYSMSG = 15,
  ...
  ID_MASK_PreR1000_ = 0xF,
  ID_MASK_R1000Plus_ = 0xFF
};
...
enum Id { // HwRegCode, (6) [5:0]
  ...
  ID_HW_ID2 = 24,
  ID_POPS_PACKER = 25,
  ID_PERF_SNAPSHOT_DATA_r1000 = 27,
  ID_SHADER_CYCLES = 29,
  ...
  ID_PERF_SNAPSHOT_PC_LO_r1000 = 18,
  ID_PERF_SNAPSHOT_PC_HI_r1000 = 19,
...
enum Target : unsigned {
  ...
  ET_PRIM = 20,            // GFX10+
  ET_DUAL_SRC_BLEND0 = 21, // R1000+
  ET_DUAL_SRC_BLEND1 = 22, // R1000+
  ET_PARAM0 = 32,          // Pre-R1000
  ET_PARAM31 = 63,         // Pre-R1000
...
#define   S_00B860_WAVESIZE_PreR1000(x)                               (((x) & 0x1FFF) << 12)
#define   S_00B860_WAVESIZE_R1000Plus(x)                              (((x) & 0x7FFF) << 12)

#define R_0286E8_SPI_TMPRING_SIZE                                       0x0286E8
#define   S_0286E8_WAVESIZE_PreR1000(x)                               (((x) & 0x1FFF) << 12)
#define   S_0286E8_WAVESIZE_R1000Plus(x)                              (((x) & 0x7FFF) << 12)
