...
#ifndef LLVM_LIB_TARGET_RVGPU_RVGPUINSTRUCTIONSELECTOR_H
#define LLVM_LIB_TARGET_RVGPU_RVGPUINSTRUCTIONSELECTOR_H
...
#include "RVGPUGenGlobalISel.inc"
...
class RVGPUInstructionSelector final : public InstructionSelector {
private:
  MachineRegisterInfo *MRI;
  const RVSubtarget *Subtarget;

public:
  RVGPUInstructionSelector(const RVSubtarget &STI,
...
private:
  ...
  bool selectG_RVGPU_MAD_64_32(MachineInstr &I) const;
  ...
  bool selectImageIntrinsic(MachineInstr &MI,
                            const RVGPU::ImageDimIntrinsicInfo *Intr) const;
