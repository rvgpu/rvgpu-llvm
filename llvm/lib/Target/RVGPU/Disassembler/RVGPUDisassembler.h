//===- RVGPUDisassembler.hpp - Disassembler for RVGPU ISA -----*- C++ -*-===//
//
...
/// \file
///
/// This file contains declaration for RVGPU ISA disassembler
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_RVGPU_DISASSEMBLER_RVGPUDISASSEMBLER_H
#define LLVM_LIB_TARGET_RVGPU_DISASSEMBLER_RVGPUDISASSEMBLER_H
...
public:
  ...
  ~RVGPUDisassembler() override = default;
...
class RVGPUSymbolizer : public MCSymbolizer {
private:
  void *DisInfo;
  std::vector<uint64_t> ReferencedAddresses;

public:
  RVGPUSymbolizer(MCContext &Ctx, std::unique_ptr<MCRelocationInfo> &&RelInfo,
                   void *disInfo)
...
#endif // LLVM_LIB_TARGET_RVGPU_DISASSEMBLER_RVGPUDISASSEMBLER_H
