...
#ifndef LLVM_LIB_TARGET_RVGPU_RVGPUMACHINELEGALIZER_H
#define LLVM_LIB_TARGET_RVGPU_RVGPUMACHINELEGALIZER_H
...
class RVGPULegalizerInfo final : public LegalizerInfo {
...
public:
  ...
  bool buildPCRelGlobalAddress(Register DstReg, LLT PtrTy, MachineIRBuilder &B,
                               ...
                               unsigned GAFlags = RVInstrInfo::MO_NONE) const;
  ...
  bool legalizeImageIntrinsic(
      ...
      const RVGPU::ImageDimIntrinsicInfo *ImageDimIntr) const;
