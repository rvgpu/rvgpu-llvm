//===-- RVGPUTargetMachine.h - RVGPU TargetMachine Interface --*- C++ -*-===//
//
...
//
/// \file
/// The RVGPU TargetMachine interface definition for hw codegen targets.
//
//===----------------------------------------------------------------------===//
...
public:
  RVGPUPassConfig(LLVMTargetMachine &TM, PassManagerBase &PM);
...
#endif // LLVM_LIB_TARGET_RVGPU_RVGPUTARGETMACHINE_H
