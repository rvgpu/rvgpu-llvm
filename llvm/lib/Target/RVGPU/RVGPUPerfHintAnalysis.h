//===- RVGPUPerfHintAnalysis.h ---- analysis of memory traffic -*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_RVGPU_MDGPUPERFHINTANALYSIS_H
#define LLVM_LIB_TARGET_RVGPU_MDGPUPERFHINTANALYSIS_H
...
struct RVGPUPerfHintAnalysis : public CallGraphSCCPass {
  static char ID;

public:
  RVGPUPerfHintAnalysis() : CallGraphSCCPass(ID) {}
...
#endif // LLVM_LIB_TARGET_RVGPU_MDGPUPERFHINTANALYSIS_H
