...
#define DEBUG_TYPE "rvgpu-memory-utils"
...
bool isReallyAClobber(const Value *Ptr, MemoryDef *Def, AAResults *AA) {
  ...
  if (const IntrinsicInst *II = dyn_cast<IntrinsicInst>(DefInst)) {
    ...
    case Intrinsic::rvgpu_s_barrier_signal:
    ...
    case Intrinsic::rvgpu_s_barrier_wait:
    case Intrinsic::rvgpu_s_barrier_leave:
    case Intrinsic::rvgpu_s_get_barrier_state:
    case Intrinsic::rvgpu_s_wakeup_barrier:
    case Intrinsic::rvgpu_wave_barrier:
    case Intrinsic::rvgpu_sched_barrier:
    case Intrinsic::rvgpu_sched_group_barrier:
      return false;
    default:
      break;
    }
