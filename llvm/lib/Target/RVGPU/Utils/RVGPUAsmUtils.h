//===-- RVGPUAsmUtils.h - AsmParser/InstPrinter common ---------*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_RVGPU_UTILS_RVGPUASMUTILS_H
#define LLVM_LIB_TARGET_RVGPU_UTILS_RVGPUASMUTILS_H
...
extern StringLiteral const UfmtSymbolicR1000[];
extern unsigned const DfmtNfmt2UFmtGFX10[];
extern unsigned const DfmtNfmt2UFmtR1000[];
