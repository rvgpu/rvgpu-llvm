//===-- RVGPUPALMetadata.h - PAL metadata handling -------------*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_RVGPU_RVGPUPALMETADATA_H
#define LLVM_LIB_TARGET_RVGPU_RVGPUPALMETADATA_H
...
public:
  // Read the rvgpu.pal.metadata supplied by the frontend, ready for
  ...
  // This is called from RVGPUTargetAsmStreamer::Finish().
  ...
  // This is called from RVGPUTargetELFStreamer::Finish().
...
#endif // LLVM_LIB_TARGET_RVGPU_RVGPUPALMETADATA_H
