...
unsigned getCodeObjectVersion(const Module &M) {
  if (auto Ver = mdconst::extract_or_null<ConstantInt>(
      M.getModuleFlag("rvgpu_code_object_version"))) {
...
bool isVOPD(unsigned Opc) {
  return RVGPU::hasNamedOperand(Opc, RVGPU::OpName::src0X);
}

bool isMAC(unsigned Opc) {
  return Opc == RVGPU::V_MAC_F32_e64_gfx6_gfx7 ||
         Opc == RVGPU::V_MAC_F32_e64_gfx10 ||
         Opc == RVGPU::V_MAC_F32_e64_vi ||
         Opc == RVGPU::V_MAC_LEGACY_F32_e64_gfx6_gfx7 ||
         Opc == RVGPU::V_MAC_LEGACY_F32_e64_gfx10 ||
         ...
         Opc == RVGPU::V_DOT4C_I32_I8_e64_vi ||
         Opc == RVGPU::V_DOT8C_I32_I4_e64_vi;
}
...
bool isPermlane16(unsigned Opc) {
  return Opc == RVGPU::V_PERMLANE16_B32_gfx10 ||
         ...
         Opc == RVGPU::V_PERMLANEX16_VAR_B32_e64_gfx12;
}

bool isGenericAtomic(unsigned Opc) {
  return Opc == RVGPU::G_RVGPU_ATOMIC_FMIN ||
         Opc == RVGPU::G_RVGPU_ATOMIC_FMAX ||
         Opc == RVGPU::G_RVGPU_BUFFER_ATOMIC_SWAP ||
         Opc == RVGPU::G_RVGPU_BUFFER_ATOMIC_ADD ||
         Opc == RVGPU::G_RVGPU_BUFFER_ATOMIC_SUB ||
         Opc == RVGPU::G_RVGPU_BUFFER_ATOMIC_SMIN ||
         Opc == RVGPU::G_RVGPU_BUFFER_ATOMIC_UMIN ||
         Opc == RVGPU::G_RVGPU_BUFFER_ATOMIC_SMAX ||
         Opc == RVGPU::G_RVGPU_BUFFER_ATOMIC_UMAX ||
         Opc == RVGPU::G_RVGPU_BUFFER_ATOMIC_AND ||
         Opc == RVGPU::G_RVGPU_BUFFER_ATOMIC_OR ||
         Opc == RVGPU::G_RVGPU_BUFFER_ATOMIC_XOR ||
         Opc == RVGPU::G_RVGPU_BUFFER_ATOMIC_INC ||
         Opc == RVGPU::G_RVGPU_BUFFER_ATOMIC_DEC ||
         Opc == RVGPU::G_RVGPU_BUFFER_ATOMIC_FADD ||
         Opc == RVGPU::G_RVGPU_BUFFER_ATOMIC_FMIN ||
         Opc == RVGPU::G_RVGPU_BUFFER_ATOMIC_FMAX ||
         Opc == RVGPU::G_RVGPU_BUFFER_ATOMIC_CMPSWAP ||
         Opc == RVGPU::G_RVGPU_ATOMIC_CMPXCHG;
}
...
ComponentProps::ComponentProps(const MCInstrDesc &OpDesc) {
  ...
  for (CompOprIdx = Component::SRC1; CompOprIdx < OperandsNum; ++CompOprIdx) {
    if (OpDesc.operands()[CompOprIdx].OperandType == RVGPU::OPERAND_KIMM32) {
...
void RVGPUTargetID::setTargetIDFromFeaturesString(StringRef FS) {
...
void RVGPUTargetID::setTargetIDFromTargetIDStream(StringRef TargetID) {
...
unsigned getMaxWorkGroupsPerCU(const MCSubtargetInfo *STI,
  ...
  if (STI->getTargetTriple().getArch() != Triple::rvgpu)
    return 8;
...
unsigned getNumExtraSGPRs(const MCSubtargetInfo *STI, bool VCCUsed,
  ...
  if (Version.Major < 8) {
    ...
    if (FlatScrUsed ||
        STI->getFeatureBits().test(RVGPU::FeatureArchitectedFlatScratch))
      ExtraSGPRs = 6;
  }
...
unsigned getNumExtraSGPRs(const MCSubtargetInfo *STI, bool VCCUsed,
  ...
  return getNumExtraSGPRs(STI, VCCUsed, FlatScrUsed,
                          STI->getFeatureBits().test(RVGPU::FeatureXNACK));
}
...
void initDefaultRVKernelCodeT(rv_kernel_code_t &Header,
  ...
  Header.rv_machine_version_major = Version.Major;
  Header.rv_machine_version_minor = Version.Minor;
  Header.rv_machine_version_stepping = Version.Stepping;
  ...
  if (Version.Major >= 10) {
    if (STI->getFeatureBits().test(FeatureWavefrontSize32)) {
      ...
      Header.code_properties |= RV_CODE_PROPERTY_ENABLE_WAVEFRONT_SIZE32;
    }
...
bool getHasColorExport(const Function &F) {
  ...
  return F.getFnAttributeAsParsedInteger(
             "rvgpu-color-export",
             F.getCallingConv() == CallingConv::RVGPU_PS ? 1 : 0) != 0;
}

bool getHasDepthExport(const Function &F) {
  return F.getFnAttributeAsParsedInteger("rvgpu-depth-export", 0) != 0;
}
...
bool hasXNACK(const MCSubtargetInfo &STI) {
  return STI.hasFeature(RVGPU::FeatureXNACK);
}

bool hasSRAMECC(const MCSubtargetInfo &STI) {
  return STI.hasFeature(RVGPU::FeatureSRAMECC);
}

bool hasMIMG_R128(const MCSubtargetInfo &STI) {
  return STI.hasFeature(RVGPU::FeatureMIMG_R128) && !STI.hasFeature(RVGPU::FeatureR128A16);
}

bool hasA16(const MCSubtargetInfo &STI) {
  return STI.hasFeature(RVGPU::FeatureA16);
}

bool hasG16(const MCSubtargetInfo &STI) {
  return STI.hasFeature(RVGPU::FeatureG16);
}

bool hasPackedD16(const MCSubtargetInfo &STI) {
  return !STI.hasFeature(RVGPU::FeatureUnpackedD16VMem) && !isCI(STI) &&
         !isSI(STI);
}

bool hasGDS(const MCSubtargetInfo &STI) {
  return STI.hasFeature(RVGPU::FeatureGDS);
}
...
bool isSI(const MCSubtargetInfo &STI) {
  return STI.hasFeature(RVGPU::FeatureSouthernIslands);
}

bool isCI(const MCSubtargetInfo &STI) {
  return STI.hasFeature(RVGPU::FeatureSeaIslands);
}
...
bool isGFX9(const MCSubtargetInfo &STI) {
  return STI.hasFeature(RVGPU::FeatureGFX9);
}
...
bool isGFX12(const MCSubtargetInfo &STI) {
  return STI.getFeatureBits()[RVGPU::FeatureGFX12];
}
...
bool isGFX10Before1030(const MCSubtargetInfo &STI) {
  return isGFX10(STI) && !RVGPU::isGFX10_BEncoding(STI);
}

bool isGCN3Encoding(const MCSubtargetInfo &STI) {
  return STI.hasFeature(RVGPU::FeatureGCN3Encoding);
}

bool isGFX10_AEncoding(const MCSubtargetInfo &STI) {
  return STI.hasFeature(RVGPU::FeatureGFX10_AEncoding);
}

bool isGFX10_BEncoding(const MCSubtargetInfo &STI) {
  return STI.hasFeature(RVGPU::FeatureGFX10_BEncoding);
}
...
bool isGFX940(const MCSubtargetInfo &STI) {
  return STI.hasFeature(RVGPU::FeatureGFX940Insts);
}
...
bool hasVOPD(const MCSubtargetInfo &STI) {
  return STI.hasFeature(RVGPU::FeatureVOPD);
}

bool hasDPPSrc1SGPR(const MCSubtargetInfo &STI) {
  return STI.hasFeature(RVGPU::FeatureDPPSrc1SGPR);
}
...
bool isSGPR(unsigned Reg, const MCRegisterInfo* TRI) {
  const MCRegisterClass SGPRClass = TRI->getRegClass(RVGPU::SReg_32RegClassID);
  const unsigned FirstSubReg = TRI->getSubReg(Reg, RVGPU::sub0);
...
bool isKImmOperand(const MCInstrDesc &Desc, unsigned OpNo) {
  assert(OpNo < Desc.NumOperands);
  unsigned OpType = Desc.operands()[OpNo].OperandType;
  return OpType >= RVGPU::OPERAND_KIMM_FIRST &&
         OpType <= RVGPU::OPERAND_KIMM_LAST;
}
...
bool isSISrcInlinableOperand(const MCInstrDesc &Desc, unsigned OpNo) {
  assert(OpNo < Desc.NumOperands);
  unsigned OpType = Desc.operands()[OpNo].OperandType;
  return (OpType >= RVGPU::OPERAND_REG_INLINE_C_FIRST &&
          OpType <= RVGPU::OPERAND_REG_INLINE_C_LAST) ||
         (OpType >= RVGPU::OPERAND_REG_INLINE_AC_FIRST &&
...
unsigned getRegBitWidth(unsigned RCID) {
  ...
  case RVGPU::AGPR_LO16RegClassID:
    return 16;
  case RVGPU::SGPR_32RegClassID:
  case RVGPU::VGPR_32RegClassID:
  case RVGPU::VRegOrLds_32RegClassID:
  case RVGPU::AGPR_32RegClassID:
  case RVGPU::VS_32RegClassID:
  case RVGPU::AV_32RegClassID:
  case RVGPU::SReg_32RegClassID:
  case RVGPU::SReg_32_XM0RegClassID:
  case RVGPU::SRegOrLds_32RegClassID:
    return 32;
  case RVGPU::SGPR_64RegClassID:
  case RVGPU::VS_64RegClassID:
  case RVGPU::SReg_64RegClassID:
  case RVGPU::VReg_64RegClassID:
  case RVGPU::AReg_64RegClassID:
  case RVGPU::SReg_64_XEXECRegClassID:
  case RVGPU::VReg_64_Align2RegClassID:
  case RVGPU::AReg_64_Align2RegClassID:
  case RVGPU::AV_64RegClassID:
  case RVGPU::AV_64_Align2RegClassID:
    return 64;
  case RVGPU::SGPR_96RegClassID:
  case RVGPU::SReg_96RegClassID:
  case RVGPU::VReg_96RegClassID:
  case RVGPU::AReg_96RegClassID:
  case RVGPU::VReg_96_Align2RegClassID:
  case RVGPU::AReg_96_Align2RegClassID:
  case RVGPU::AV_96RegClassID:
  case RVGPU::AV_96_Align2RegClassID:
    return 96;
  case RVGPU::SGPR_128RegClassID:
  case RVGPU::SReg_128RegClassID:
  case RVGPU::VReg_128RegClassID:
  case RVGPU::AReg_128RegClassID:
  case RVGPU::VReg_128_Align2RegClassID:
  case RVGPU::AReg_128_Align2RegClassID:
  case RVGPU::AV_128RegClassID:
  case RVGPU::AV_128_Align2RegClassID:
    return 128;
  case RVGPU::SGPR_160RegClassID:
  case RVGPU::SReg_160RegClassID:
  case RVGPU::VReg_160RegClassID:
  case RVGPU::AReg_160RegClassID:
  case RVGPU::VReg_160_Align2RegClassID:
  case RVGPU::AReg_160_Align2RegClassID:
  case RVGPU::AV_160RegClassID:
  case RVGPU::AV_160_Align2RegClassID:
    return 160;
  case RVGPU::SGPR_192RegClassID:
  case RVGPU::SReg_192RegClassID:
  case RVGPU::VReg_192RegClassID:
  case RVGPU::AReg_192RegClassID:
  case RVGPU::VReg_192_Align2RegClassID:
  case RVGPU::AReg_192_Align2RegClassID:
  case RVGPU::AV_192RegClassID:
  case RVGPU::AV_192_Align2RegClassID:
    return 192;
  case RVGPU::SGPR_224RegClassID:
  case RVGPU::SReg_224RegClassID:
  case RVGPU::VReg_224RegClassID:
  case RVGPU::AReg_224RegClassID:
  case RVGPU::VReg_224_Align2RegClassID:
  case RVGPU::AReg_224_Align2RegClassID:
  case RVGPU::AV_224RegClassID:
  case RVGPU::AV_224_Align2RegClassID:
    return 224;
  case RVGPU::SGPR_256RegClassID:
  case RVGPU::SReg_256RegClassID:
  case RVGPU::VReg_256RegClassID:
  case RVGPU::AReg_256RegClassID:
  case RVGPU::VReg_256_Align2RegClassID:
  case RVGPU::AReg_256_Align2RegClassID:
  case RVGPU::AV_256RegClassID:
  case RVGPU::AV_256_Align2RegClassID:
    return 256;
  case RVGPU::SGPR_288RegClassID:
  case RVGPU::SReg_288RegClassID:
  case RVGPU::VReg_288RegClassID:
  case RVGPU::AReg_288RegClassID:
  case RVGPU::VReg_288_Align2RegClassID:
  case RVGPU::AReg_288_Align2RegClassID:
  case RVGPU::AV_288RegClassID:
  case RVGPU::AV_288_Align2RegClassID:
    return 288;
  case RVGPU::SGPR_320RegClassID:
  case RVGPU::SReg_320RegClassID:
  case RVGPU::VReg_320RegClassID:
  case RVGPU::AReg_320RegClassID:
  case RVGPU::VReg_320_Align2RegClassID:
  case RVGPU::AReg_320_Align2RegClassID:
  case RVGPU::AV_320RegClassID:
  case RVGPU::AV_320_Align2RegClassID:
    return 320;
  case RVGPU::SGPR_352RegClassID:
  case RVGPU::SReg_352RegClassID:
  case RVGPU::VReg_352RegClassID:
  case RVGPU::AReg_352RegClassID:
  case RVGPU::VReg_352_Align2RegClassID:
  case RVGPU::AReg_352_Align2RegClassID:
  case RVGPU::AV_352RegClassID:
  case RVGPU::AV_352_Align2RegClassID:
    return 352;
  case RVGPU::SGPR_384RegClassID:
  case RVGPU::SReg_384RegClassID:
  case RVGPU::VReg_384RegClassID:
  case RVGPU::AReg_384RegClassID:
  case RVGPU::VReg_384_Align2RegClassID:
  case RVGPU::AReg_384_Align2RegClassID:
  case RVGPU::AV_384RegClassID:
  case RVGPU::AV_384_Align2RegClassID:
    return 384;
  case RVGPU::SGPR_512RegClassID:
  case RVGPU::SReg_512RegClassID:
  case RVGPU::VReg_512RegClassID:
  case RVGPU::AReg_512RegClassID:
  case RVGPU::VReg_512_Align2RegClassID:
  case RVGPU::AReg_512_Align2RegClassID:
  case RVGPU::AV_512RegClassID:
  case RVGPU::AV_512_Align2RegClassID:
    return 512;
  case RVGPU::SGPR_1024RegClassID:
  case RVGPU::SReg_1024RegClassID:
  case RVGPU::VReg_1024RegClassID:
  case RVGPU::AReg_1024RegClassID:
  case RVGPU::VReg_1024_Align2RegClassID:
  case RVGPU::AReg_1024_Align2RegClassID:
  case RVGPU::AV_1024RegClassID:
  case RVGPU::AV_1024_Align2RegClassID:
    return 1024;
  default:
...
bool hasAny64BitVGPROperands(const MCInstrDesc &OpDesc) {
  for (auto OpName : { OpName::vdst, OpName::src0, OpName::src1,
    ...
    if (OpDesc.operands()[Idx].RegClass == RVGPU::VReg_64RegClassID ||
        OpDesc.operands()[Idx].RegClass == RVGPU::VReg_64_Align2RegClassID)
      return true;
  }
