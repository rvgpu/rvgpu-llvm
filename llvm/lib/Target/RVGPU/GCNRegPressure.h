...
#ifndef LLVM_LIB_TARGET_RVGPU_GCNREGPRESSURE_H
#define LLVM_LIB_TARGET_RVGPU_GCNREGPRESSURE_H
...
struct GCNRegPressure {
  ...
  unsigned getOccupancy(const RVSubtarget &ST) const {
  ...
  bool higherOccupancy(const RVSubtarget &ST, const GCNRegPressure& O) const {
    return getOccupancy(ST) > O.getOccupancy(ST);
  }

  bool less(const RVSubtarget &ST, const GCNRegPressure& O,
...
private:
  ...
  friend Printable print(const GCNRegPressure &RP, const RVSubtarget *ST);
};
...
Printable print(const GCNRegPressure &RP, const RVSubtarget *ST = nullptr);
...
#endif // LLVM_LIB_TARGET_RVGPU_GCNREGPRESSURE_H
