...
bool RVGPUMCInstLower::lowerOperand(const MachineOperand &MO,
  ...
  case MachineOperand::MO_Register:
    MCOp = MCOperand::createReg(RVGPU::getMCReg(MO.getReg(), ST));
    return true;
  ...
  case MachineOperand::MO_MCSymbol:
    if (MO.getTargetFlags() == RVInstrInfo::MO_FAR_BRANCH_OFFSET) {
...
void RVGPUMCInstLower::lower(const MachineInstr *MI, MCInst &OutMI) const {
  ...
  const auto *TII = static_cast<const RVInstrInfo*>(ST.getInstrInfo());
