//===-- RVGPUAsmPrinter.h - Print RVGPU assembly code ---------*- C++ -*-===//
//
...
class RVGPUMachineFunctionInfo;
struct RVGPUResourceUsageAnalysis;
...
private:
  ...
  std::unique_ptr<RVGPU::HSAMD::MetadataStreamer> HSAMetadataStream;
...
public:
  ...
  RVGPUTargetStreamer* getTargetStreamer() const;
  ...
  /// Implemented in RVGPUMCInstLower.cpp
