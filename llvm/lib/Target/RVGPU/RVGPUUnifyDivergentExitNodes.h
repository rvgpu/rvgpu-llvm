//===- RVGPUUnifyDivergentExitNodes.h ------------------------------------===//
//
...
#ifndef LLVM_LIB_TARGET_RVGPU_RVGPUUNIFYDIVERGENTEXITNODES_H
#define LLVM_LIB_TARGET_RVGPU_RVGPUUNIFYDIVERGENTEXITNODES_H

#include "RVGPU.h"

namespace llvm {
class RVGPUUnifyDivergentExitNodesPass
    : public PassInfoMixin<RVGPUUnifyDivergentExitNodesPass> {
public:
...
#endif // LLVM_LIB_TARGET_RVGPU_RVGPUUNIFYDIVERGENTEXITNODES_H
