//===- RVGPUMetadataVerifier.h - MsgPack Types -----------------*- C++ -*-===//
//
...
//
/// \file
/// This is a verifier for RVGPU HSA metadata, which can verify both
...
#ifndef LLVM_BINARYFORMAT_RVGPUMETADATAVERIFIER_H
#define LLVM_BINARYFORMAT_RVGPUMETADATAVERIFIER_H
...
/// Verifier for RVGPU HSA metadata.
///
...
#endif // LLVM_BINARYFORMAT_RVGPUMETADATAVERIFIER_H
