...
//
/// \file
/// RVGPU address space definition
///
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_SUPPORT_RVGPUADDRSPACE_H
#define LLVM_SUPPORT_RVGPUADDRSPACE_H
...
} // end namespace RVGPUAS
} // end namespace llvm

#endif // LLVM_SUPPORT_RVGPUADDRSPACE_H
