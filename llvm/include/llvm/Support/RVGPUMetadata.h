...
//
/// \file
/// RVGPU metadata definitions and in-memory representations.
///
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_SUPPORT_RVGPUMETADATA_H
#define LLVM_SUPPORT_RVGPUMETADATA_H
...
constexpr char AssemblerDirectiveBegin[] = ".rv_rvgpu_hsa_metadata";
/// HSA metadata ending assembler directive.
constexpr char AssemblerDirectiveEnd[] = ".end_rv_rvgpu_hsa_metadata";
...
/// HSA metadata beginning assembler directive.
constexpr char AssemblerDirectiveBegin[] = ".rvgpu_metadata";
/// HSA metadata ending assembler directive.
constexpr char AssemblerDirectiveEnd[] = ".end_rvgpu_metadata";
} // end namespace V3
...
constexpr char AssemblerDirective[] = ".rv_rvgpu_pal_metadata";

/// PAL metadata (new MsgPack format) beginning assembler directive.
constexpr char AssemblerDirectiveBegin[] = ".rvgpu_pal_metadata";

/// PAL metadata (new MsgPack format) ending assembler directive.
constexpr char AssemblerDirectiveEnd[] = ".end_rvgpu_pal_metadata";
...
#endif // LLVM_SUPPORT_RVGPUMETADATA_H
