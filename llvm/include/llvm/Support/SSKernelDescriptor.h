...
/// * RVGPUAsmPrinter.{cpp,h}
/// * RVGPUTargetStreamer.{cpp,h}
/// * RVGPUDisassembler.{cpp,h}
//
//===----------------------------------------------------------------------===//
...
// [GFX6-R1000].
#define COMPUTE_PGM_RSRC1_GFX6_R1000(NAME, SHIFT, WIDTH)                       \
  SS_BITS_ENUM_ENTRY(COMPUTE_PGM_RSRC1_GFX6_R1000_##NAME, SHIFT, WIDTH)
// GFX9+.
...
enum : int32_t {
  ...
  COMPUTE_PGM_RSRC1_GFX6_R1000(ENABLE_DX10_CLAMP, 21, 1),
  COMPUTE_PGM_RSRC1_GFX12_PLUS(ENABLE_WG_RR_EN, 21, 1),
  COMPUTE_PGM_RSRC1(DEBUG_MODE, 22, 1),
  COMPUTE_PGM_RSRC1_GFX6_R1000(ENABLE_IEEE_MODE, 23, 1),
...
// R1000+.
#define COMPUTE_PGM_RSRC3_R1000_PLUS(NAME, SHIFT, WIDTH) \
  SS_BITS_ENUM_ENTRY(COMPUTE_PGM_RSRC3_R1000_PLUS_ ## NAME, SHIFT, WIDTH)
enum : int32_t {
  COMPUTE_PGM_RSRC3_GFX10_PLUS(SHARED_VGPR_COUNT, 0, 4),
  COMPUTE_PGM_RSRC3_GFX10(RESERVED0, 4, 8),
  COMPUTE_PGM_RSRC3_R1000_PLUS(INST_PREF_SIZE, 4, 6),
  COMPUTE_PGM_RSRC3_R1000_PLUS(TRAP_ON_START, 10, 1),
  COMPUTE_PGM_RSRC3_R1000_PLUS(TRAP_ON_END, 11, 1),
  COMPUTE_PGM_RSRC3_GFX10_PLUS(RESERVED1, 12, 19),
  COMPUTE_PGM_RSRC3_GFX10(RESERVED2, 31, 1),
  COMPUTE_PGM_RSRC3_R1000_PLUS(IMAGE_OP, 31, 1),
};
